...
var require_canvasjs_min = __commonJS({
  "node_modules/@canvasjs/charts/canvasjs.min.js"(exports, module) {
    (function() {
      ...
      function za(d) {
        d.roundRect = function(d2, T, p2, v2, ra, D, t2, A2) {
          ...
          this.beginPath();
          this.moveTo(d2 + ra, T);
          this.lineTo(d2 + p2 - ra, T);
          this.quadraticCurveTo(d2 + p2, T, d2 + p2, T + ra);
          this.lineTo(d2 + p2, T + v2 - ra);
          this.quadraticCurveTo(d2 + p2, T + v2, d2 + p2 - ra, T + v2);
      ...
      function Za(d, l, p2) {
        ...
        if (isNaN($)) {
          try {
            ...
            sa.style.display = "";
            O(sa, { position: "absolute", left: "0px", top: "-20000px", padding: "0px", margin: "0px", border: "none", whiteSpace: "pre", lineHeight: "normal", fontFamily: d, fontSize: l + "px", fontWeight: p2 });
            $ = Math.round(sa.offsetHeight);
      ...
      function K(d, l, T, v2, $) {
        v2 = v2 || [];
        $ = p($) ? gb ? { passive: false, capture: false } : false : $;
        v2.push([d, l, T, $]);
      ...
      function hb(d) {
        if (d._menuButton)
          d.exportEnabled ? (O(d._menuButton, { backgroundColor: d.toolbar.itemBackgroundColor, color: d.toolbar.fontColor }), La(d._menuButton), ta(d, d._menuButton, "menu")) : xa(d._menuButton);
          ...
          K(d._menuButton, "touchstart", function(d2) {
            l = true;
          }, d.allDOMEventHandlers);
          K(d._menuButton, "click", function() {
          ...
          K(d._menuButton, "mousemove", function() {
            l || (O(d._menuButton, { backgroundColor: d.toolbar.itemBackgroundColorOnHover, color: d.toolbar.fontColorOnHover }), 0 >= navigator.userAgent.search("MSIE") && O(d._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
          }, d.allDOMEventHandlers, true);
          K(
            d._menuButton,
            "mouseout",
            function() {
              l || (O(d._menuButton, { backgroundColor: d.toolbar.itemBackgroundColor, color: d.toolbar.fontColor }), 0 >= navigator.userAgent.search("MSIE") && O(d._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
            },
            d.allDOMEventHandlers,
            true
          );
        ...
        if (d.exportEnabled && d._dropdownMenu) {
          O(d._dropdownMenu, { backgroundColor: d.toolbar.itemBackgroundColor, color: d.toolbar.fontColor });
          for (var p2 = d._dropdownMenu.childNodes, ba = [d._cultureInfo.printText, d._cultureInfo.saveJPGText, d._cultureInfo.savePNGText], $ = 0; $ < ba.length; $++)
            O(p2[$], { backgroundColor: d.toolbar.itemBackgroundColor, color: d.toolbar.fontColor }), p2[$].innerHTML = ba[$];
        } else
          !d._dropdownMenu && (d.exportEnabled && v) && (l = false, d._dropdownMenu = document.createElement("div"), d._dropdownMenu.setAttribute("tabindex", -1), p2 = -1 !== d.theme.indexOf("dark") ? "black" : "#888888", O(d._dropdownMenu, {
            position: "absolute",
            zIndex: 1,
            userSelect: "none",
            MozUserSeelct: "none",
          ...
          }), d._dropdownMenu.style.display = "none", d._toolBar.appendChild(d._dropdownMenu), K(d._dropdownMenu, "blur", function() {
            xa(d._dropdownMenu);
            d._dropDownCloseTime = new Date();
          }, d.allDOMEventHandlers, true), p2 = document.createElement("div"), O(p2, { padding: "12px 8px 12px 8px" }), p2.innerHTML = d._cultureInfo.printText, p2.style.backgroundColor = d.toolbar.itemBackgroundColor, p2.style.color = d.toolbar.fontColor, d._dropdownMenu.appendChild(p2), K(p2, "touchstart", function(d2) {
            l = true;
          }, d.allDOMEventHandlers), K(p2, "mousemove", function() {
            l || (this.style.backgroundColor = d.toolbar.itemBackgroundColorOnHover, this.style.color = d.toolbar.fontColorOnHover);
          }, d.allDOMEventHandlers, true), K(p2, "mouseout", function() {
            l || (this.style.backgroundColor = d.toolbar.itemBackgroundColor, this.style.color = d.toolbar.fontColor);
          }, d.allDOMEventHandlers, true), K(p2, "click", function() {
            d.print();
            xa(d._dropdownMenu);
          }, d.allDOMEventHandlers, true), p2 = document.createElement("div"), O(p2, { padding: "12px 8px 12px 8px" }), p2.innerHTML = d._cultureInfo.saveJPGText, p2.style.backgroundColor = d.toolbar.itemBackgroundColor, p2.style.color = d.toolbar.fontColor, d._dropdownMenu.appendChild(p2), K(p2, "touchstart", function(d2) {
            l = true;
          }, d.allDOMEventHandlers), K(p2, "mousemove", function() {
            l || (this.style.backgroundColor = d.toolbar.itemBackgroundColorOnHover, this.style.color = d.toolbar.fontColorOnHover);
          }, d.allDOMEventHandlers, true), K(
            p2,
            "mouseout",
            function() {
              l || (this.style.backgroundColor = d.toolbar.itemBackgroundColor, this.style.color = d.toolbar.fontColor);
            ...
            xa(d._dropdownMenu);
          }, d.allDOMEventHandlers, true), p2 = document.createElement("div"), O(p2, { padding: "12px 8px 12px 8px" }), p2.innerHTML = d._cultureInfo.savePNGText, p2.style.backgroundColor = d.toolbar.itemBackgroundColor, p2.style.color = d.toolbar.fontColor, d._dropdownMenu.appendChild(p2), K(
            p2,
            "touchstart",
            function(d2) {
              l = true;
      ...
      function Ma(d, l, T, ba) {
        v && bb ? (ba = !p(ba) && ba ? d.getContext("2d", { willReadFrequently: true }) : d.getContext("2d"), Na = ba.webkitBackingStorePixelRatio || ba.mozBackingStorePixelRatio || ba.msBackingStorePixelRatio || ba.oBackingStorePixelRatio || ba.backingStorePixelRatio || 1, ma = Ta / Na, d.width = l * ma, d.height = T * ma, Ta !== Na && (d.style.width = l + "px", d.style.height = T + "px", ba.scale(ma, ma))) : (d.width = l, d.height = T);
      }
      function ib(d) {
        if (!jb) {
          var l = false, p2 = false;
          "undefined" === typeof qa.Chart.creditHref ? (d.creditHref = ja("iuuqr;..b`ow`rkr/bnl."), d.creditText = ja("B`ow`rKR/bnl")) : (l = d.updateOption("creditText"), p2 = d.updateOption("creditHref"));
      ...
      function va(d, l, p2) {
        ...
        ba.setAttribute("class", "canvasjs-chart-canvas");
        Ma(ba, d, l, p2);
        v || "undefined" === typeof G_vmlCanvasManager || G_vmlCanvasManager.initElement(ba);
        return ba;
      }
      function O(d, l) {
        for (var p2 in l)
      ...
      function ta(d, l, p2) {
        l.getAttribute("state") || (l.style.backgroundColor = d.toolbar.itemBackgroundColor, l.style.color = d.toolbar.fontColor, l.style.border = "none", O(l, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
        l.getAttribute("state") !== p2 && (l.setAttribute("state", p2), l.setAttribute("type", "button"), O(l, { padding: "5px 12px", cursor: "pointer", "float": "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }), l.innerHTML = "<img src='" + kb[p2].image + "' alt='" + d._cultureInfo[p2 + "Text"] + "' />", O(l.childNodes[0], { height: "95%", pointerEvents: "none" }));
      ...
      function Z(d, l, v2, ba, $) {
        ...
        d = {};
        this.theme && p(this.parent) && p(l) && p(ba) ? d = p(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[l]) && (null === ba ? d = this.parent.themeOptions[l] : 0 < this.parent.themeOptions[l].length && (ba = Math.min(this.parent.themeOptions[l].length - 1, ba), d = this.parent.themeOptions[l][ba]));
        this.themeOptions = d;
        this.options = v2 ? v2 : { _isPlaceholder: true };
        this.setOptions(this.options, d);
      }
      function Ea(d, l, p2, v2, $) {
        "undefined" === typeof $ && ($ = 0);
        this._padding = $;
        this._x1 = d;
        this._y1 = l;
      ...
      function Aa(d, l) {
        Aa.base.constructor.call(this, "Title", "title", l, null, d);
        this.chart = d;
        this.canvas = d.canvas;
        this.ctx = this.chart.ctx;
        this.optionsName = "title";
        if (p(this.options.margin) && d.options.subtitles) {
          for (var v2 = d.options.subtitles, ba = 0; ba < v2.length; ba++)
            if ((p(v2[ba].horizontalAlign) && "center" === this.horizontalAlign || v2[ba].horizontalAlign === this.horizontalAlign) && (p(v2[ba].verticalAlign) && "top" === this.verticalAlign || v2[ba].verticalAlign === this.verticalAlign) && !v2[ba].dockInsidePlotArea === !this.dockInsidePlotArea) {
              this.margin = 0;
              break;
            }
        }
      ...
      var Ha = false, wa = {}, v = !!document.createElement("canvas").getContext, qa = {
        Chart: {
          width: 500,
          height: 400,
          zoomEnabled: false,
      ...
      }, Ka = { en: {} }, t = v ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Fa = v ? "Impact, Charcoal, sans-serif" : "Arial", Ba = {
      ...
      var ia = 20, A = 14, Xa = {
        ...
        subtitles: [{ fontFamily: Fa, fontSize: A, fontColor: ga, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
        data: [{ indexLabelFontFamily: t, indexLabelFontSize: A, indexLabelFontColor: ga, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
        axisX: [{ titleFontFamily: t, titleFontSize: ia, titleFontColor: ga, titleFontWeight: "normal", labelFontFamily: t, labelFontSize: A, labelFontColor: X, labelFontWeight: "normal", lineThickness: 1, lineColor: S, tickThickness: 1, tickColor: S, gridThickness: 0, gridColor: S, stripLines: [{
          labelFontFamily: t,
          labelFontSize: A,
          ...
          color: "#FF7300",
          thickness: 1
        }], crosshair: { labelFontFamily: t, labelFontSize: A, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: W, color: V, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" } }],
        axisX2: [{
          titleFontFamily: t,
          titleFontSize: ia,
          titleFontColor: ga,
          ...
          crosshair: { labelFontFamily: t, labelFontSize: A, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: W, color: V, thickness: 1, lineDashType: "dash" },
          scaleBreaks: {
            type: "zigzag",
            spacing: "2%",
            lineColor: "#BBBBBB",
        ...
        axisY2: [{ titleFontFamily: t, titleFontSize: ia, titleFontColor: ga, titleFontWeight: "normal", labelFontFamily: t, labelFontSize: A, labelFontColor: X, labelFontWeight: "normal", lineThickness: 1, lineColor: S, tickThickness: 1, tickColor: S, gridThickness: 1, gridColor: S, stripLines: [{
          labelFontFamily: t,
          labelFontSize: A,
          labelFontColor: "#FF7300",
          labelFontWeight: "normal",
        ...
        legend: { fontFamily: t, fontSize: 14, fontColor: ga, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" },
      ...
      V = "#40BAF1";
      W = "#F5F5F5";
      var ia = 20, A = 14, cb = { colorSet: "colorSet2", title: { fontFamily: t, fontSize: 33, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: t, fontSize: A, fontColor: "#3A3A3A", fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{
        indexLabelFontFamily: t,
        indexLabelFontSize: A,
        indexLabelFontColor: "#666666",
        indexLabelFontWeight: "normal",
        indexLabelLineThickness: 1
      }], axisX: [{ titleFontFamily: t, titleFontSize: ia, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: t, labelFontSize: A, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 1, lineColor: "#BBBBBB", tickThickness: 1, tickColor: "#BBBBBB", gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{
        labelFontFamily: t,
        labelFontSize: A,
        ...
        color: "#FFA500",
        thickness: 1
      }], crosshair: { labelFontFamily: t, labelFontSize: A, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" } }], axisX2: [{
        titleFontFamily: t,
        titleFontSize: ia,
        ...
        scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
      }], axisY2: [{ titleFontFamily: t, titleFontSize: ia, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: t, labelFontSize: A, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 0, lineColor: "#BBBBBB", tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB", stripLines: [{
        labelFontFamily: t,
        labelFontSize: A,
        labelFontColor: "#FFA500",
        labelFontWeight: "normal",
        ...
        color: "#FFA500",
        thickness: 1
      }], crosshair: { labelFontFamily: t, labelFontSize: A, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: "black", color: "black", thickness: 1, lineDashType: "dot" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" } }], legend: { fontFamily: t, fontSize: 14, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" }, toolTip: {
        fontFamily: t,
        fontSize: 14,
        fontStyle: "normal",
        cornerRadius: 0,
      ...
      ia = 20;
      A = 14;
      Fa = { colorSet: "colorSet12", backgroundColor: "#2A2A2A", title: { fontFamily: Fa, fontSize: 32, fontColor: ga, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{
        fontFamily: Fa,
        fontSize: A,
        fontColor: ga,
        fontWeight: "normal",
        verticalAlign: "top",
        margin: 5
      }], toolbar: { itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372", buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" }, data: [{ indexLabelFontFamily: t, indexLabelFontSize: A, indexLabelFontColor: X, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
        titleFontFamily: t,
        titleFontSize: ia,
        titleFontColor: X,
        titleFontWeight: "normal",
        ...
        gridColor: S,
        stripLines: [{ labelFontFamily: t, labelFontSize: A, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }],
        crosshair: { labelFontFamily: t, labelFontSize: A, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: W, color: V, thickness: 1, lineDashType: "dash" },
        ...
        scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
      }], axisY: [{ titleFontFamily: t, titleFontSize: ia, titleFontColor: X, titleFontWeight: "normal", labelFontFamily: t, labelFontSize: A, labelFontColor: X, labelFontWeight: "normal", lineThickness: 1, lineColor: S, tickThickness: 1, tickColor: S, gridThickness: 1, gridColor: S, stripLines: [{
        labelFontFamily: t,
        labelFontSize: A,
        labelFontColor: "#FF7300",
        labelFontWeight: "normal",
        ...
        color: "#FF7300",
        thickness: 1
      }], crosshair: { labelFontFamily: t, labelFontSize: A, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: W, color: V, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" } }], axisY2: [{
        titleFontFamily: t,
        titleFontSize: ia,
        titleFontColor: X,
        titleFontWeight: "normal",
      ...
      }, toolTip: { fontFamily: t, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1, fontColor: X, backgroundColor: "rgba(0, 0, 0, .7)" } };
      S = "#FFFFFF";
      X = ga = "#FAFAFA";
      V = "#40BAF1";
      W = "#F5F5F5";
      var ia = 20, A = 14, Oa = { light1: Xa, light2: cb, dark1: Fa, dark2: {
        colorSet: "colorSet2",
        backgroundColor: "#32373A",
        title: { fontFamily: t, fontSize: 32, fontColor: ga, fontWeight: "normal", verticalAlign: "top", margin: 5 },
        subtitles: [{
          fontFamily: t,
          fontSize: A,
          fontColor: ga,
        ...
        data: [{ indexLabelFontFamily: t, indexLabelFontSize: A, indexLabelFontColor: X, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
        axisX: [{
          titleFontFamily: t,
          titleFontSize: ia,
          titleFontColor: X,
        ...
        axisY: [{ titleFontFamily: t, titleFontSize: ia, titleFontColor: X, titleFontWeight: "normal", labelFontFamily: t, labelFontSize: A, labelFontColor: X, labelFontWeight: "normal", lineThickness: 0, lineColor: S, tickThickness: 1, tickColor: S, gridThickness: 1, gridColor: S, stripLines: [{
          labelFontFamily: t,
          labelFontSize: A,
          labelFontColor: "#FF7300",
          labelFontWeight: "normal",
          ...
          color: "#FF7300",
          thickness: 1
        }], crosshair: { labelFontFamily: t, labelFontSize: A, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: W, color: V, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" } }],
        axisY2: [{
          titleFontFamily: t,
          titleFontSize: ia,
          titleFontColor: X,
        ...
        toolTip: { fontFamily: t, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1, fontColor: X, backgroundColor: "rgba(0, 0, 0, .7)" }
      }, theme1: Xa, theme2: cb, theme3: Xa }, I = { numberDuration: 1, yearDuration: 314496e5, monthDuration: 2592e6, weekDuration: 6048e5, dayDuration: 864e5, hourDuration: 36e5, minuteDuration: 6e4, secondDuration: 1e3, millisecondDuration: 1, dayOfWeekFromInt: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ") };
      (function() {
        wa.fSDec = function(d) {
      ...
      var gb = function() {
        ...
        return function(A2, H2, P) {
          var S2 = P ? P.days : l, U2 = P ? P.months : v2, K2 = P ? P.shortDays : p2, I2 = P ? P.shortMonths : $;
          P = "";
          var O2 = false;
          A2 = A2 && A2.getTime ? A2 : A2 ? new Date(A2) : new Date();
          if (isNaN(A2))
            throw SyntaxError("invalid date");
          "UTC:" === H2.slice(0, 4) && (H2 = H2.slice(4), O2 = true);
          P = O2 ? "getUTC" : "get";
          var Z2 = A2[P + "Date"](), N = A2[P + "Day"](), Y = A2[P + "Month"](), a = A2[P + "FullYear"](), g = A2[P + "Hours"](), c = A2[P + "Minutes"](), b = A2[P + "Seconds"](), e = A2[P + "Milliseconds"](), h = O2 ? 0 : A2.getTimezoneOffset();
          return P = H2.replace(d, function(r) {
            switch (r) {
              ...
              case "TT":
                return 12 > g ? "AM" : "PM";
              case "K":
                return O2 ? "UTC" : (String(A2).match(t2) || [""]).pop().replace(D, "");
              case "z":
                return (0 < h ? "-" : "+") + Math.floor(Math.abs(h) / 60);
              case "zz":
                return (0 < h ? "-" : "+") + ca(Math.floor(Math.abs(h) / 60), 2);
              case "zzz":
                return (0 < h ? "-" : "+") + ca(Math.floor(Math.abs(h) / 60), 2) + ca(Math.abs(h) % 60, 2);
              default:
        ...
        l = String(l);
        var D = 1, A2 = p2 = "", H2 = -1, P = [], S2 = [], U2 = 0, K2 = 0, I2 = 0, O2 = false, Z2 = 0, A2 = l.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
        l = null;
        for (var N = 0; A2 && N < A2.length; N++)
          if (l = A2[N], "." === l && 0 > H2)
            ...
            if ("%" === l)
              ...
              "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || (O2 = true);
            0 > H2 ? (P.push(l), "#" === l || "0" === l ? U2++ : "," === l && I2++) : (S2.push(l), "#" !== l && "0" !== l || K2++);
          }
        O2 && (l = Math.floor(d), A2 = -Math.floor(Math.log(d) / Math.LN10 + 1), Z2 = 0 === d ? 0 : 0 === l ? -(U2 + A2) : nb(l).length - U2, D /= Math.pow(10, Z2));
        0 > H2 && (H2 = N);
        D = (d * D).toFixed(K2);
        l = D.split(".");
        D = (l[0] + "").split("");
        d = (l[1] + "").split("");
        D && "0" === D[0] && D.shift();
        for (O2 = A2 = N = K2 = H2 = 0; 0 < P.length; )
          if (l = P.pop(), "#" === l || "0" === l)
            if (H2++, H2 === U2) {
              var Y = D, D = [];
              if ("0" === l)
                for (l = U2 - K2 - (Y ? Y.length : 0); 0 < l; )
                  Y.unshift("0"), l--;
              for (; 0 < Y.length; )
                p2 = Y.pop() + p2, O2++, 0 === O2 % A2 && (N === I2 && 0 < Y.length) && (p2 = t2 + p2);
            } else
              0 < D.length ? (p2 = D.pop() + p2, K2++, O2++) : "0" === l && (p2 = "0" + p2, K2++, O2++), 0 === O2 % A2 && (N === I2 && 0 < D.length) && (p2 = t2 + p2);
          else
            "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? "," === l ? (N++, A2 = O2, O2 = 0, 0 < D.length && (p2 = t2 + p2)) : p2 = 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + p2 : l + p2 : (l = 0 > Z2 ? l.replace("+", "").replace("-", "") : l.replace("-", ""), p2 += l.replace(/[0]+/, function(a) {
              return ca(Z2, a.length);
            }));
        t2 = "";
        ...
        return { x: l, y: p2 };
      }, bb = true, Ta = window.devicePixelRatio || 1, Na = 1, ma = bb ? Ta / Na : 1, ea = function(d, l, p2, v2, t2, A2, D, H2, U2, P, S2, O2, K2) {
        ...
        true === S2 && (d.save(), d.beginPath(), d.moveTo(l, p2), d.lineTo(l + I2, p2 + I2), d.lineTo(l + I2, t2 - I2), d.lineTo(l, t2), d.closePath(), D = d.createLinearGradient(l + I2, (t2 + p2) / 2, l, (t2 + p2) / 2), D.addColorStop(0, A2), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), d.fillStyle = D, d.fill(), d.restore());
        true === O2 && (d.save(), d.beginPath(), d.moveTo(v2, p2), d.lineTo(v2 - I2, p2 + I2), d.lineTo(v2 - I2, t2 - I2), d.lineTo(v2, t2), D = d.createLinearGradient(v2 - I2, (t2 + p2) / 2, v2, (t2 + p2) / 2), D.addColorStop(0, A2), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), d.fillStyle = D, D.addColorStop(0, A2), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), d.fillStyle = D, d.fill(), d.closePath(), d.restore());
      }, ja = function(d) {
      ...
      Z.prototype.createUserOptions = function(d) {
        if ("undefined" !== typeof d || this.options._isPlaceholder)
          if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
            ...
            this.options._isPlaceholder || (Da(p2), v2 = p2.indexOf(this.options));
      ...
      Z.prototype.updateOption = function(d) {
        ...
        var l = qa[this._defaultsKey], v2 = {}, t2 = this[d], A2 = this._themeOptionsKey, H2 = this._index;
        this.theme && p(this.parent) && p(A2) && p(H2) ? v2 = p(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && this.parent.themeOptions && (this.options.theme && Oa[this.options.theme] ? v2 = Oa[this.options.theme] : this.parent.themeOptions[A2] && (null === H2 ? v2 = this.parent.themeOptions[A2] : 0 < this.parent.themeOptions[A2].length && (v2 = Math.min(this.parent.themeOptions[A2].length - 1, H2), v2 = this.parent.themeOptions[A2][v2])));
      ...
      Ea.prototype.registerSpace = function(d, p2) {
      ...
      Ea.prototype.unRegisterSpace = function(d, p2) {
        "top" === d ? this._topOccupied -= p2.height : "bottom" === d ? this._bottomOccupied -= p2.height : "left" === d ? this._leftOccupied -= p2.width : "right" === d && (this._rightOccupied -= p2.width);
      };
      ...
      ka.prototype._wrapText = function() {
        var d = new String(Ga(String(this.text))), p2 = [], v2 = this.ctx.font, t2 = 0, A2 = 0;
        this.ctx.font = this._getFontString();
        if (0 === this.frontSize)
          A2 = t2 = 0;
        else
          for (; 0 < d.length; ) {
            ...
            p2.push(D);
            var I2 = A2, A2 = Math.max(A2, D.width), t2 = t2 + D.height, d = Ga(d.slice(D.text.length, d.length));
      ...
      Wa.prototype.get = function(d, p2) {
        var v2 = null;
        0 < this.pool.length ? (v2 = this.pool.pop(), Ma(v2, d, p2)) : v2 = va(d, p2);
        return v2;
      };
      ...
      var Qa = { addTheme: function(d, p2) {
        ...
        v2 = v2 || "en";
        if (Ka[v2])
          return da(d, p2 || "#,##0.##", new Ja(v2));
        throw "Unknown Culture Name";
      }, formatDate: function(d, p2, v2) {
        v2 = v2 || "en";
        if (Ka[v2])
          return Ca(d, p2 || "DD MMM YYYY", new Ja(v2));
        throw "Unknown Culture Name";
      } };
      ...
      t = Qa.Chart = function() {
        ...
        function l(a, g, c) {
          g = g || {};
          p(c) ? (this.predefinedThemes = Oa, this.optionsName = this.parent = this.index = null) : (this.parent = c.parent, this.index = c.index, this.predefinedThemes = c.predefinedThemes, this.optionsName = c.optionsName, this.stockChart = c.stockChart, this.panel = a, this.isOptionsInArray = c.isOptionsInArray);
          ...
          (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", g = a = 0, a = this.options.width ? this.width : 0 < this.container.clientWidth ? this.container.clientWidth : this.width, g = c && c.height ? c.height : this.options.height ? this.height : 0 < this.container.clientHeight ? this.container.clientHeight : this.height, this.width = a, this.height = g, this.x1 = this.y1 = 0, this.x2 = this.width, this.y2 = this.height, this.selectedColorSet = "undefined" !== typeof Ba[this.colorSet] ? Ba[this.colorSet] : Ba.colorSet1, this._canvasJSContainer = document.createElement("div"), this._canvasJSContainer.setAttribute("class", "canvasjs-chart-container"), this._canvasJSContainer.style.position = "relative", this._canvasJSContainer.style.textAlign = "left", this._canvasJSContainer.style.cursor = "auto", this._canvasJSContainer.style.direction = "ltr", v || (this._canvasJSContainer.style.height = "0px"), this.container.appendChild(this._canvasJSContainer), this.canvas = va(a, g), this._preRenderCanvas = va(a, g), this.canvas.style.position = "absolute", this.canvas.style.WebkitUserSelect = "none", this.canvas.style.MozUserSelect = "none", this.canvas.style.msUserSelect = "none", this.canvas.style.userSelect = "none", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", za(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", za(this._preRenderCtx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = va(a, g), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")), this.overlaidCanvas = va(a, g), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.style.WebkitUserSelect = "none", this.overlaidCanvas.style.MozUserSelect = "none", this.overlaidCanvas.style.msUserSelect = "none", this.overlaidCanvas.style.userSelect = "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline = "top", za(this.overlaidCanvasCtx)), this._eventManager = new W2(this), this.windowResizeHandler = K(window, "resize", function() {
            ...
            right: "1px",
            top: "1px"
          }), this._canvasJSContainer.appendChild(this._toolBar), this.bounds = { x1: 0, y1: 0, x2: this.width, y2: this.height }, K(this.overlaidCanvas, "click", function(a2) {
            ...
            this.allDOMEventHandlers
          ), K(this.overlaidCanvas, "mouseout", function(a2) {
            b._mouseEventHandler(a2);
          }, this.allDOMEventHandlers), K(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" : "touchstart", function(a2) {
            ...
            this.allDOMEventHandlers
          ), K(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerCancel" : "touchcancel", function(a2) {
            b._touchEventHandler(a2);
        ...
        function A2(a, g, c, b, e, h, r, x, J, k) {
          ...
          a.beginPath();
          J && 0 < x.thickness ? (a.moveTo(b - r.thickness / 2, Math.round((c + e) / 2) - q), a.lineTo(g + r.thickness / 2, Math.round((c + e) / 2) - q)) : 0 < x.thickness && (a.moveTo(Math.round((g + b) / 2) - q, c + r.thickness / 2), a.lineTo(Math.round((g + b) / 2) - q, e - r.thickness / 2));
          a.stroke();
          a.strokeStyle = r.color || h;
          a.lineWidth = r.thickness || 2;
          a.setLineDash && a.setLineDash(H(r.dashType, r.thickness));
          a.beginPath();
          J && 0 < r.thickness ? (a.moveTo(b - m, c), a.lineTo(b - m, e), a.moveTo(g + m, c), a.lineTo(g + m, e)) : 0 < r.thickness && (a.moveTo(g, c + m), a.lineTo(b, c + m), a.moveTo(g, e - m), a.lineTo(b, e - m));
          a.stroke();
          a.restore();
        }
        function S2(a, g) {
        ...
        function X2(a, g, c, b) {
          X2.base.constructor.call(this, "DataSeries", "data", g, c, a);
          this.chart = a;
          this.canvas = a.canvas;
        ...
        function D(a, g, c, b, e, h) {
          ...
          this.options.scaleBreaks && (this.scaleBreaks = new ia2(this.chart, this.options.scaleBreaks, ++this.chart._eventManager.lastObjectId, this));
          this.stripLines = [];
        ...
        function ia2(a, g, c, b) {
          ia2.base.constructor.call(this, "ScaleBreaks", "scaleBreaks", g, null, b);
          this.id = c;
          this.chart = a;
          this.ctx = this.chart.ctx;
          this.axis = b;
        ...
        function ga2(a, g, c, b, e, h) {
          ga2.base.constructor.call(this, "Break", g, c, b, h);
          this.id = e;
          this.chart = a;
          this.ctx = this.chart.ctx;
          this.scaleBreaks = h;
        ...
        function ca2(a, g, c) {
          ca2.base.constructor.call(this, "Crosshair", "crosshair", g, null, c);
          this.chart = a;
          this.ctx = this.chart.ctx;
          this.axis = c;
          ...
          if (this.options.zoomEnabled || this.panEnabled) {
            if (this._zoomButton)
              ...
              K(this._zoomButton, "mouseout", function() {
                ...
                ), 0 >= navigator.userAgent.search("MSIE") && O(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
              }, this.allDOMEventHandlers);
            }
            this._resetButton ? (O(this._resetButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), this._resetButton.title = this._cultureInfo.resetText) : (g = false, xa(this._resetButton = document.createElement("button")), ta(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " + this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton), K(this._resetButton, "touchstart", function(a2) {
              g = true;
              ...
              this.allDOMEventHandlers
            ), K(this._resetButton, "mouseout", function() {
          ...
          if (this.options.data) {
            for (var c = 0; c < this.options.data.length; c++)
              if (a++, !this.options.data[c].type || 0 <= l._supportedChartTypes.indexOf(this.options.data[c].type)) {
                var b = new X2(this, this.options.data[c], a - 1, ++this._eventManager.lastObjectId);
                if (!p(b) && b.dataPoints) {
          ...
          if (this.height) {
            ...
            for (g = 0; g < this.plotInfo.plotTypes.length; g++)
              for (var h = this.plotInfo.plotTypes[g], r = 0; r < h.plotUnits.length; r++) {
                ...
                this.animatedRender && (x.targetCanvasCtx.miterLimit = e, J && c.push(J));
              }
            ...
            this.animatedRender && 0 < this._indexLabels.length && (e = va(this.width, this.height).getContext("2d"), za(e), c.push(this.renderIndexLabels(e)));
            var m = this;
            if (0 < c.length)
              m.disableToolTip = true, m._animator.animate(200, m.animationDuration, function(a2) {
                ...
                for (var e2 = 0; e2 < c.length; e2++)
                  J = c[e2], 1 > a2 && "undefined" !== typeof J.startTimePercent ? a2 >= J.startTimePercent && J.animationCallback(
            ...
            Ha && (m = this, setTimeout(function() {
              ...
              a2 && (Ma(a2, m.width, m.height), a2.getContext("2d").drawImage(
            ...
            for (var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = false, r = 0; r < a.dataSeriesIndexes.length; r++) {
              ...
              for (J = 0; J < x.dataPoints.length; J++) {
                ...
                if (0 < J) {
                  ...
                  null !== e && null !== x.dataPoints[J - 1].y && (a.axisY.logarithmic ? (d2 = e / x.dataPoints[J - 1].y, 1 > d2 && (d2 = 1 / d2), g.minDiff > d2 && 1 !== d2 && (g.minDiff = d2)) : (d2 = e - x.dataPoints[J - 1].y, 0 > d2 && (d2 *= -1), g.minDiff > d2 && 0 !== d2 && (g.minDiff = d2)));
                }
                if (b < n && !k)
                  null !== e && (q = b);
                else {
        ...
        l.prototype._processStackedPlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = false, r = [], x = [], J = Infinity, k = -Infinity, m = {}, q = 0; q < a.dataSeriesIndexes.length; q++) {
              var n = this.data[a.dataSeriesIndexes[q]], f = 0, d2 = false, w = false, y;
              ...
              for (f = 0; f < n.dataPoints.length; f++) {
                ...
                if (b < s && !d2)
                  ...
                  b < c.viewPortMin && (c.viewPortMin = b);
                  b > c.viewPortMax && (c.viewPortMax = b);
                  null === n.dataPoints[f].y ? c.viewPortMin === b && y < b && (c.viewPortMin = y) : (m[b] = (m[b] || 0) + n.dataPoints[f].y, n.dataPointEOs[f].cumulativeY = m[b], a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? r[b] ? r[b] += e : (r[b] = e, J = Math.min(e, J)) : x[b] ? x[b] += e : (x[b] = e, k = Math.max(e, k)));
                }
              }
            ...
            for (f in r)
              r.hasOwnProperty(f) && !isNaN(f) && (a = r[f], a < g.min && (g.min = Math.min(a, J)), a > g.max && (g.max = a), f < c.viewPortMin || f > c.viewPortMax || (a < g.viewPortMin && (g.viewPortMin = Math.min(a, J)), a > g.viewPortMax && (g.viewPortMax = a)));
            for (f in x)
        ...
        l.prototype._processStacked100PlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = false, r = false, x = false, J = {}, k = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
              var q = this.data[a.dataSeriesIndexes[m]], n = 0, f = false, d2 = false, w;
              ...
              for (n = 0; n < q.dataPoints.length; n++) {
                ...
                if (b < y && !f)
                  ...
                  b < c.viewPortMin && (c.viewPortMin = b);
                  b > c.viewPortMax && (c.viewPortMax = b);
                  null === e ? c.viewPortMin === b && w < b && (c.viewPortMin = w) : (J[b] = (J[b] || 0) + q.dataPoints[n].y, q.dataPointEOs[n].cumulativeY = J[b], a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? r = true : 0 > e && (x = true), k[b] = k[b] ? k[b] + Math.abs(e) : Math.abs(e));
                }
              }
            ...
            ), g.min = p(g.viewPortMin) ? 1 : Math.min(g.viewPortMin, 1)) : r && !x ? (g.max = p(g.viewPortMax) ? 99 : Math.max(g.viewPortMax, 99), g.min = p(g.viewPortMin) ? 1 : Math.min(g.viewPortMin, 1)) : r && x ? (g.max = p(g.viewPortMax) ? 99 : Math.max(g.viewPortMax, 99), g.min = p(g.viewPortMin) ? -99 : Math.min(g.viewPortMin, -99)) : !r && x && (g.max = p(g.viewPortMax) ? -1 : Math.max(g.viewPortMax, -1), g.min = p(g.viewPortMin) ? -99 : Math.min(g.viewPortMin, -99));
            g.viewPortMin = g.min;
            g.viewPortMax = g.max;
            a.dataPointYSums = k;
          }
        ...
        l.prototype._processMultiYPlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h, r, x = false, J = 0; J < a.dataSeriesIndexes.length; J++) {
              var k = this.data[a.dataSeriesIndexes[J]], m = 0, q = false, n = false, f, d2, p2;
          ...
          if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = false, r = 0; r < a.dataSeriesIndexes.length; r++) {
              ...
              for (d2 = 0; d2 < x.dataPoints.length; d2++)
                "undefined" !== typeof x.dataPoints[d2].isCumulativeSum && true === x.dataPoints[d2].isCumulativeSum ? (x.dataPointEOs[d2].cumulativeSumYStartValue = 0, x.dataPointEOs[d2].cumulativeSum = 0 === d2 ? 0 : x.dataPointEOs[d2 - 1].cumulativeSum, x.dataPoints[d2].y = 0 === d2 ? 0 : x.dataPointEOs[d2 - 1].cumulativeSum) : "undefined" !== typeof x.dataPoints[d2].isIntermediateSum && true === x.dataPoints[d2].isIntermediateSum ? (x.dataPointEOs[d2].cumulativeSumYStartValue = q, x.dataPointEOs[d2].cumulativeSum = 0 === d2 ? 0 : x.dataPointEOs[d2 - 1].cumulativeSum, x.dataPoints[d2].y = 0 === d2 ? 0 : b, q = 0 === d2 ? 0 : x.dataPointEOs[d2 - 1].cumulativeSum, b = 0) : (e = "number" !== typeof x.dataPoints[d2].y ? 0 : x.dataPoints[d2].y, x.dataPointEOs[d2].cumulativeSumYStartValue = 0 === d2 ? 0 : x.dataPointEOs[d2 - 1].cumulativeSum, x.dataPointEOs[d2].cumulativeSum = 0 === d2 ? e : x.dataPointEOs[d2 - 1].cumulativeSum + e, b += e);
              for (d2 = 0; d2 < x.dataPoints.length; d2++)
                if ("undefined" === typeof x.dataPoints[d2].x && (x.dataPoints[d2].x = d2 + (a.axisX.logarithmic ? 1 : 0)), x.dataPoints[d2].x.getTime ? (h = true, b = x.dataPoints[d2].x.getTime()) : b = x.dataPoints[d2].x, e = x.dataPoints[d2].y, b < c.min && (c.min = b), b > c.max && (c.max = b), x.dataPointEOs[d2].cumulativeSum < g.min && (g.min = x.dataPointEOs[d2].cumulativeSum), x.dataPointEOs[d2].cumulativeSum > g.max && (g.max = x.dataPointEOs[d2].cumulativeSum), 0 < d2 && (a.axisX.logarithmic ? (q = b / x.dataPoints[d2 - 1].x, 1 > q && (q = 1 / q), c.minDiff > q && 1 !== q && (c.minDiff = q)) : (q = b - x.dataPoints[d2 - 1].x, 0 > q && (q *= -1), c.minDiff > q && 0 !== q && (c.minDiff = q)), null !== e && null !== x.dataPoints[d2 - 1].y && (a.axisY.logarithmic ? (e = x.dataPointEOs[d2].cumulativeSum / x.dataPointEOs[d2 - 1].cumulativeSum, 1 > e && (e = 1 / e), g.minDiff > e && 1 !== e && (g.minDiff = e)) : (e = x.dataPointEOs[d2].cumulativeSum - x.dataPointEOs[d2 - 1].cumulativeSum, 0 > e && (e *= -1), g.minDiff > e && 0 !== e && (g.minDiff = e)))), !(b < n) || k) {
                  if (!k && (k = true, 0 < d2)) {
                    d2 -= 2;
                    continue;
                  }
        ...
        l.prototype.calculateAutoBreaks = function() {
          ...
          function g(a2) {
            if (a2.dataSeriesIndexes && !(1 > a2.dataSeriesIndexes.length)) {
              ...
              if (b2 || c2)
                for (var f2 = a2.axisY.dataInfo, g2 = a2.axisX.dataInfo, h2, r2 = g2.min, k2 = g2.max, m2 = f2.min, q2 = f2.max, g2 = g2._dataRanges, f2 = f2._dataRanges, n2, x2 = 0, d3 = 0; d3 < a2.dataSeriesIndexes.length; d3++) {
                  var J = e.data[a2.dataSeriesIndexes[d3]];
                  if (!(4 > J.dataPoints.length)) {
                    for (x2 = 0; x2 < J.dataPoints.length; x2++)
                      if (b2 && (n2 = (k2 + 1 - r2) * Math.max(parseFloat(a2.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, h2 = J.dataPoints[x2].x.getTime ? J.dataPoints[x2].x.getTime() : J.dataPoints[x2].x, n2 = Math.floor((h2 - r2) / n2), h2 < g2[n2].min && (g2[n2].min = h2), h2 > g2[n2].max && (g2[n2].max = h2)), c2) {
            ...
            for (r = 0; r < this._axes.length; r++)
              if (this._axes[r].dataInfo._dataRanges) {
                ...
                if (this._axes[r].dataInfo.dataPointYNegativeSums) {
                  ...
                  m = k;
                  for (x in n)
                    n.hasOwnProperty(x) && !isNaN(x) && (q = -1 * n[x], p(q) || (f = Math.floor((q - d2) / b), q < m[f].min && (m[f].min = q), q > m[f].max && (m[f].max = q)));
        ...
        l.prototype._touchEventHandler = function(a) {
          if (a.changedTouches && this.interactivityEnabled) {
            ...
            switch (a.type) {
              ...
              case "touchend":
              case "MSPointerUp":
                var h = this._lastTouchData && this._lastTouchData.time ? new Date() - this._lastTouchData.time : 0, g = "touchstart" === this._lastTouchEventType || "MSPointerDown" === this._lastTouchEventType || 300 > h ? ["mouseup", "click"] : ["mouseup"];
                break;
              default:
                return;
            }
        ...
        l.prototype._plotAreaMouseMove = function(a, g) {
          if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!e || 2 < Math.abs(c) || !h || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled)) {
              if (this.panEnabled)
                e = { x1: e ? this.plotArea.x1 + c : this.plotArea.x1, y1: h ? this.plotArea.y1 + b : this.plotArea.y1, x2: e ? this.plotArea.x2 + c : this.plotArea.x2, y2: h ? this.plotArea.y2 + b : this.plotArea.y2 }, clearTimeout(r._panTimerId), r._panTimerId = setTimeout(function(b2, c2, e2, f) {
                  return function() {
          ...
          for (r = 0; r < k.length; r++) {
            ...
            if (isFinite(q.dataInfo.minDiff)) {
              if (p2 = q.getApparentDifference(n, f, null, true), !(h || !(this.panEnabled && q.scaleBreaks && q.scaleBreaks._appliedBreaks.length) && (q.logarithmic && p2 < Math.pow(q.dataInfo.minDiff, 3) || !q.logarithmic && p2 < 3 * Math.abs(q.dataInfo.minDiff)) || n < q.minimum || f > q.maximum))
                d2.push(q), m.push({ val1: n, val2: f }), x = true;
              else if (!e) {
                x = false;
                break;
              }
        ...
        l.prototype.renderIndexLabels = function(a) {
          ...
          for (a = 0; a < this._indexLabels.length; a++) {
            var m = this._indexLabels[a], q = m.chartType.toLowerCase(), n, f, x = na("indexLabelFontColor", m.dataPoint, m.dataSeries), Ra = na("indexLabelFontSize", m.dataPoint, m.dataSeries), d2 = na("indexLabelFontFamily", m.dataPoint, m.dataSeries), k = na("indexLabelFontStyle", m.dataPoint, m.dataSeries);
            n = na(
            ...
            var C = m.dataPoint.indexLabelFormatter ? m.dataPoint.indexLabelFormatter(l2) : m.dataPoint.indexLabel ? this.replaceKeywordsWithValue(m.dataPoint.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : m.dataSeries.indexLabelFormatter ? m.dataSeries.indexLabelFormatter(l2) : m.dataSeries.indexLabel ? this.replaceKeywordsWithValue(m.dataSeries.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : null;
            if (null !== C && "" !== C) {
              var u = na("indexLabelPlacement", m.dataPoint, m.dataSeries), l2 = na("indexLabelOrientation", m.dataPoint, m.dataSeries), B = na("indexLabelTextAlign", m.dataPoint, m.dataSeries), t3 = m.direction, e = m.dataSeries.axisX, r = m.dataSeries.axisY, A3 = false, w = new ka(g, { x: 0, y: 0, maxWidth: f ? f : 0.5 * this.width, maxHeight: h ? 5 * Ra : 1.5 * Ra, angle: "horizontal" === l2 ? 0 : -90, text: C, padding: 0, backgroundColor: w, textAlign: B, fontSize: Ra, fontFamily: d2, fontWeight: n, fontColor: x, fontStyle: k, textBaseline: "middle" });
              w.measureText();
              ...
              if ("normal" === this.plotInfo.axisPlacement) {
                ...
                if ("inside" !== u)
                  e = c.y1, h = c.y2, 0 < t3 ? (f = m.point.y + w._lineHeight / 2 - k - x - b, f < e && (f = "auto" === u ? Math.max(m.point.y, e) + w._lineHeight / 2 + x + b : e + w._lineHeight / 2 + x + b, A3 = f + ("horizontal" === l2 ? k - w._lineHeight / 2 : 0) > m.point.y, !A3 || (0 <= q.indexOf("line") || 0 <= q.indexOf("area")) || (f -= b))) : (f = m.point.y + w._lineHeight / 2 + x + b, f > h - k + w._lineHeight / 2 - x && (f = "auto" === u ? Math.min(m.point.y, h) + w._lineHeight / 2 - k - x - b : h + w._lineHeight / 2 - k - x - b, A3 = f - ("horizontal" === l2 ? w._lineHeight / 2 : k) < m.point.y, !A3 || (0 <= q.indexOf("line") || 0 <= q.indexOf("area")) || (f += b)));
                else {
                  ...
                  if (0 < t3) {
                    ...
                    f = Math.min(m.point.y, b), f > h - k - x && ("bubble" === q || "scatter" === q) && (f = Math.min(m.point.y + x, c.y2 - k - x));
                  f = Math.min(f, h);
                }
              } else
                0 <= q.indexOf("line") || 0 <= q.indexOf("area") || 0 <= q.indexOf("scatter") ? (u = "auto", r = 4) : 0 <= q.indexOf("stacked") ? "auto" === u && (u = "inside") : "bubble" === q && (u = "inside"), f = m.point.y + w._lineHeight / 2 - k / 2, "inside" !== u ? (h = c.x1, e = c.x2, 0 > t3 ? (n = m.point.x - d2 + ("horizontal" === l2 ? 0 : w._lineHeight / 2) - r - b, ("horizontal" === l2 ? n : n - w._lineHeight / 2) < h && (n = "auto" === u ? Math.max(m.point.x, h) + ("horizontal" === l2 ? 0 : w._lineHeight / 2) + x + b : h + ("horizontal" === l2 ? 0 : w._lineHeight / 2) + r, (A3 = n + d2 - ("horizontal" === l2 ? 0 : w._lineHeight / 2) > m.point.x) && (n -= b))) : (n = m.point.x + ("horizontal" === l2 ? 0 : w._lineHeight / 2) + r + b, ("horizontal" === l2 ? n : n - w._lineHeight / 2) > e - d2 - r - b && (n = "auto" === u ? Math.min(m.point.x, e) - ("horizontal" === l2 ? d2 : d2 - w._lineHeight / 2) - r - b : e - d2 - r + ("horizontal" === l2 ? 0 : w._lineHeight / 2), (A3 = n - ("horizontal" === l2 ? 0 : w._lineHeight / 2) < m.point.x) && (n += b)))) : (h = Math.max(m.bounds.x1, c.x1), Math.min(m.bounds.x2, c.x2), b = 0 <= q.indexOf("range") || "error" === q ? 0 > t3 ? Math.max(m.bounds.x1, c.x1) : Math.min(m.bounds.x2, c.x2) - d2 - r + ("horizontal" === l2 ? 0 : w._lineHeight / 2) : (Math.max(m.bounds.x1, c.x1) + Math.min(m.bounds.x2, c.x2)) / 2 - d2 / 2 + ("horizontal" === l2 ? 0 : w._lineHeight / 2), n = 0 > t3 ? b : Math.min(m.point.x, b), n = Math.max(n, h + ("horizontal" === l2 ? 0 : w._lineHeight / 2 + x)));
              "vertical" === l2 && (f += k - w._lineHeight / 2, 0 <= "ohlc candlestick boxandwhisker column rangecolumn stackedcolumn stackedcolumn100 error".split(" ").indexOf(q) && (A3 = 0 < t3 ? f + ("horizontal" === l2 ? k - w._lineHeight / 2 : 0) > m.point.y : f - ("horizontal" === l2 ? w._lineHeight / 2 : k) < m.point.y), "bubble" === q || "scatter" === q) && (n += w._lineHeight / 2 - Ra / 2);
              w.x = n;
              w.y = f;
              w.render(true);
              z && ("inside" !== u && (0 > q.indexOf("bar") && ("error" !== q || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2 || !A3) && (-1 === "ohlc candlestick boxandwhisker column rangecolumn stackedcolumn stackedcolumn100 error".split(" ").indexOf(q) && ("error" !== q || m.axisSwapped) && m.point.y > c.y1 && m.point.y < c.y2 || !A3)) && (g.lineWidth = z, g.strokeStyle = s ? s : "gray", g.setLineDash && g.setLineDash(H(y, z)), g.beginPath(), g.moveTo(m.point.x, m.point.y), 0 <= q.indexOf("bar") || "error" === q && m.axisSwapped ? g.lineTo(n + (0 < m.direction ? 0 : d2) + ("vertical" === l2 ? -w._lineHeight / 2 : 0), f + ("vertical" === l2 ? -k / 2 : k / 2 - w._lineHeight / 2)) : 0 <= q.indexOf("column") || "error" === q && !m.axisSwapped ? g.lineTo(n + d2 / 2 - ("horizontal" === l2 ? 0 : w._lineHeight / 2), f + ("vertical" === l2 ? f - k < m.point.y ? 0 : -k : (f - w._lineHeight / 2 < m.point.y ? k : 0) - w._lineHeight / 2)) : 0 <= q.indexOf("waterfall") ? g.lineTo(n + d2 / 2 - ("horizontal" === l2 ? 0 : w._lineHeight / 2), "vertical" === l2 ? 0 < t3 && f < m.point.y ? f : 0 > t3 && f - k > m.point.y ? f - k : m.point.y : 0 < t3 && f + k - w._lineHeight / 2 < m.point.y ? f + k - w._lineHeight / 2 : 0 > t3 && f - w._lineHeight / 2 > m.point.y ? f - w._lineHeight / 2 : m.point.y) : g.lineTo(n + d2 / 2 - ("horizontal" === l2 ? 0 : w._lineHeight / 2), f + ("vertical" === l2 ? f - k < m.point.y ? 0 : -k : (f + k - w._lineHeight / 2 < m.point.y ? k : 0) - w._lineHeight / 2)), g.stroke());
            }
          }
                ...
                for (var E = false, s = 0; s < m.length; s++)
                  if (l2 = m[s].x.getTime ? m[s].x.getTime() : m[s].x, !(l2 < a.axisX.dataInfo.viewPortMin || l2 > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !E)))
                    if ("number" !== typeof m[s].y)
                      ...
                      y || E ? (!y && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || q === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(
                        r.x,
                        r.y
                      ), q = k.nullDataLineDashType, c.setLineDash(n)), c.lineTo(l2, u), v && b.lineTo(l2, u)) : (c.beginPath(), c.moveTo(l2, u), v && (b.beginPath(), b.moveTo(l2, u))), E = y = false) : (c.lineTo(l2, u), v && b.lineTo(l2, u), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(l2, u), v && (b.stroke(), b.beginPath(), b.moveTo(l2, u))));
                      r = { x: l2, y: u };
                      s < m.length - 1 && (w !== (m[s].lineColor || p2) || q !== (m[s].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(l2, u), w = m[s].lineColor || p2, c.strokeStyle = w, c.setLineDash && (m[s].lineDashType ? (q = m[s].lineDashType, c.setLineDash(H(q, k.lineThickness))) : (q = k.lineDashType, c.setLineDash(f))));
                      if (0 !== m[s].markerSize && (0 < m[s].markerSize || 0 < k.markerSize)) {
                        var B = k.getMarkerProperties(s, l2, u, c);
                        h.push(B);
                        C = U(C);
                        v && h.push({ x: l2, y: u, ctx: b, type: B.type, size: B.size, color: C, borderColor: C, borderThickness: B.borderThickness });
                      }
                ...
                for (var E = false, s = 0; s < m.length; s++)
                  if (z = m[s].getTime ? m[s].x.getTime() : m[s].x, !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !E)))
                    if ("number" !== typeof m[s].y)
                      ...
                      l2 || E ? (!l2 && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || q === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(r.x, r.y), q = k.nullDataLineDashType, c.setLineDash(n)), c.lineTo(z, C), c.lineTo(z, u), v && (b.lineTo(z, C), b.lineTo(z, u))) : (c.beginPath(), c.moveTo(z, u), v && (b.beginPath(), b.moveTo(z, u))), E = l2 = false) : (c.lineTo(z, C), v && b.lineTo(z, C), c.lineTo(z, u), v && b.lineTo(z, u), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(z, u), v && (b.stroke(), b.beginPath(), b.moveTo(z, u))));
                      r = { x: z, y: u };
                      s < m.length - 1 && (w !== (m[s].lineColor || p2) || q !== (m[s].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(z, u), w = m[s].lineColor || p2, c.strokeStyle = w, c.setLineDash && (m[s].lineDashType ? (q = m[s].lineDashType, c.setLineDash(H(q, k.lineThickness))) : (q = k.lineDashType, c.setLineDash(f))));
                      0 !== m[s].markerSize && (0 < m[s].markerSize || 0 < k.markerSize) && (C = k.getMarkerProperties(s, z, u, c), h.push(C), B = U(B), v && h.push({ x: z, y: u, ctx: b, type: C.type, size: C.size, color: B, borderColor: B, borderThickness: C.borderThickness }));
                ...
                for (z = false, l2 = 0; l2 < m.length; l2++)
                  if (s = m[l2].getTime ? m[l2].x.getTime() : m[l2].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
                    if ("number" !== typeof m[l2].y)
                      0 < l2 && !z && (k.connectNullData ? b.setLineDash && (0 < u.length && (k.options.nullDataLineDashType || !m[l2 - 1].lineDashType)) && (u[u.length - 1].newLineDashArray = n, q = k.nullDataLineDashType) : (g(u), u = [])), z = true;
                    else {
                      s = a.axisX.convertValueToPixel(s);
                      z = a.axisY.convertValueToPixel(m[l2].y);
                      var E = k.dataPointIds[l2];
                      this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: d2, dataPointIndex: l2, x1: s, y1: z };
                      u[u.length] = { x: s, y: z };
                      l2 < m.length - 1 && (w !== (m[l2].lineColor || p2) || q !== (m[l2].lineDashType || k.lineDashType)) && (w = m[l2].lineColor || p2, u[u.length - 1].newStrokeStyle = w, b.setLineDash && (m[l2].lineDashType ? (q = m[l2].lineDashType, u[u.length - 1].newLineDashArray = H(q, k.lineThickness)) : (q = k.lineDashType, u[u.length - 1].newLineDashArray = f)));
                      if (0 !== m[l2].markerSize && (0 < m[l2].markerSize || 0 < k.markerSize)) {
                        var C = k.getMarkerProperties(l2, s, z, b);
                        r.push(C);
                        E = U(E);
                        v && r.push({ x: s, y: z, ctx: e, type: C.type, size: C.size, color: E, borderColor: E, borderThickness: C.borderThickness });
                      }
                      (m[l2].indexLabel || k.indexLabel || m[l2].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                        chartType: "spline",
                        dataPoint: m[l2],
                        dataSeries: k,
                        point: { x: s, y: z },
                        direction: 0 > m[l2].y === a.axisY.reversed ? 1 : -1,
                        color: p2
                      });
                      z = false;
                    }
        ...
        l.prototype.renderColumn = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              if (0 < p2.length) {
                for (var l2 = 5 < q && f.bevelEnabled ? true : false, h = 0; h < p2.length; h++)
                  if (p2[h].getTime ? d2 = p2[h].x.getTime() : d2 = p2[h].x, !(d2 < a.axisX.dataInfo.viewPortMin || d2 > a.axisX.dataInfo.viewPortMax) && "number" === typeof p2[h].y) {
                    ...
                    ea(c, a.axisX.reversed ? y : r, x, a.axisX.reversed ? r : y, s, b, 0, null, l2 && (a.axisY.reversed ? 0 > p2[h].y : 0 <= p2[h].y), (a.axisY.reversed ? 0 <= p2[h].y : 0 > p2[h].y) && l2, false, false, f.fillOpacity);
                    b = f.dataPointIds[h];
                    this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: h, x1: r, y1: x, x2: y, y2: s };
                    b = U(b);
                    v && ea(
                      this._eventManager.ghostCtx,
                      a.axisX.reversed ? y : r,
                      x,
                      a.axisX.reversed ? r : y,
                      s,
                      b,
                      0,
                      null,
                    ...
                    (p2[h].indexLabel || f.indexLabel || p2[h].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({ chartType: "column", dataPoint: p2[h], dataSeries: f, point: { x: r + (y - r) / 2, y: 0 > p2[h].y === a.axisY.reversed ? x : s }, direction: 0 > p2[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: r, y1: Math.min(x, s), x2: y, y2: Math.max(x, s) }, color: b });
                  }
              }
            }
            ...
            c.restore();
            return { source: g, dest: this.plotArea.ctx, animationCallback: N.yScaleAnimation, easingFunction: N.easing.easeOutQuart, animationBase: k < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : k > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : k };
          }
        };
        l.prototype.renderStackedColumn = function(a) {
          var g = a.targetCanvasCtx || this.plotArea.ctx, c = v ? this._preRenderCtx : g;
          if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, e = this.plotArea, h = [], r = [], x = [], d2 = [], k = 0, m, q, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), k = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, p2 = a.axisX.dataInfo.minDiff;
                ...
                for (k = 0; k < s.length; k++)
                  if (b = s[k].x.getTime ? s[k].x.getTime() : s[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                    ...
                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[k].y)
                      ...
                      C = r[b] ? r[b] : 0, E = q + C, q = n + C, r[b] = C + (E - q);
                    b = s[k].color ? s[k].color : y._colorSet[k % y._colorSet.length];
                    ea(c, m, a.axisY.reversed ? E : q, u, a.axisY.reversed ? q : E, b, 0, null, z && (a.axisY.reversed ? 0 > s[k].y : 0 <= s[k].y), (a.axisY.reversed ? 0 <= s[k].y : 0 > s[k].y) && z, false, false, y.fillOpacity);
                    b = y.dataPointIds[k];
                    ...
                    b = U(b);
                    v && ea(this._eventManager.ghostCtx, m, q, u, E, b, 0, null, false, false, false, false);
            ...
            c.restore();
            return { source: g, dest: this.plotArea.ctx, animationCallback: N.yScaleAnimation, easingFunction: N.easing.easeOutQuart, animationBase: n < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : n > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : n };
          }
        };
                ...
                for (var z = 5 < p2 && y.bevelEnabled ? true : false, k = 0; k < s.length; k++)
                  if (b = s[k].x.getTime ? s[k].x.getTime() : s[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                    ...
                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[k].y) {
                      ...
                      C = "undefined" !== typeof r[b] ? r[b] : 0, E = q + C, q = n + C, a.dataSeriesIndexes.length - 1 === f && 1 >= Math.abs(e.y2 - E) && (E = e.y2), r[b] = C + (E - q);
                    b = s[k].color ? s[k].color : y._colorSet[k % y._colorSet.length];
                    ea(c, m, a.axisY.reversed ? E : q, u, a.axisY.reversed ? q : E, b, 0, null, z && (a.axisY.reversed ? 0 > s[k].y : 0 <= s[k].y), (a.axisY.reversed ? 0 <= s[k].y : 0 > s[k].y) && z, false, false, y.fillOpacity);
                    b = y.dataPointIds[k];
                    ...
                    (s[k].indexLabel || y.indexLabel || s[k].indexLabelFormatter || y.indexLabelFormatter) && this._indexLabels.push({
                      ...
                      dataPoint: s[k],
                      dataSeries: y,
                      point: { x: m + (u - m) / 2, y: 0 <= s[k].y ? q : E },
                      direction: 0 > s[k].y === a.axisY.reversed ? 1 : -1,
                      bounds: { x1: m, y1: Math.min(q, E), x2: u, y2: Math.max(q, E) },
                      color: b
                    });
                  }
              }
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
              ...
              if (0 < p2.length) {
                ...
                for (h = 0; h < p2.length; h++)
                  if (p2[h].getTime ? d2 = p2[h].x.getTime() : d2 = p2[h].x, !(d2 < a.axisX.dataInfo.viewPortMin || d2 > a.axisX.dataInfo.viewPortMax) && "number" === typeof p2[h].y) {
                    x = a.axisX.convertValueToPixel(d2);
                    ...
                    var y = a.axisX.reversed ? x - q << 0 : x + q << 0, s;
                    0 <= p2[h].y ? s = k : (s = r, r = k);
                    b = p2[h].color ? p2[h].color : f._colorSet[h % f._colorSet.length];
                    ea(c, a.axisY.reversed ? r : s, a.axisX.reversed ? y : x, a.axisY.reversed ? s : r, a.axisX.reversed ? x : y, b, 0, null, l2, false, false, false, f.fillOpacity);
                    b = f.dataPointIds[h];
                    this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: h, x1: s, y1: x, x2: r, y2: y };
                    b = U(b);
                    v && ea(
                      this._eventManager.ghostCtx,
                      s,
                      a.axisX.reversed ? y : x,
                      r,
                      a.axisX.reversed ? x : y,
                      b,
                      0,
                      null,
                      false,
                    ...
                    (p2[h].indexLabel || f.indexLabel || p2[h].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: p2[h], dataSeries: f, point: { x: 0 <= p2[h].y ? r : s, y: x + (y - x) / 2 }, direction: 0 > p2[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(s, r), y1: x, x2: Math.max(s, r), y2: y }, color: b });
                  }
              }
            }
            v && (g.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(
        ...
        l.prototype.renderStackedBar = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (k = 0; k < s.length; k++)
                  if (b = s[k].x.getTime ? s[k].x.getTime() : s[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                    ...
                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[k].y)
                      ...
                      C = r[b] ? r[b] : 0, E = m - C, m = n - C, r[b] = C + (m - E);
                    b = s[k].color ? s[k].color : y._colorSet[k % y._colorSet.length];
                    ea(c, a.axisY.reversed ? m : E, q, a.axisY.reversed ? E : m, u, b, 0, null, z, false, false, false, y.fillOpacity);
                    b = y.dataPointIds[k];
                    ...
                    (s[k].indexLabel || y.indexLabel || s[k].indexLabelFormatter || y.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar", dataPoint: s[k], dataSeries: y, point: { x: 0 <= s[k].y ? m : E, y: q + (u - q) / 2 }, direction: 0 > s[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(E, m), y1: q, x2: Math.max(E, m), y2: u }, color: b });
                  }
              }
            }
            v && (g.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(
            ...
            c.restore();
            return { source: g, dest: this.plotArea.ctx, animationCallback: N.xScaleAnimation, easingFunction: N.easing.easeOutQuart, animationBase: n < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : n > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : n };
          }
        };
                ...
                for (k = 0; k < s.length; k++)
                  if (b = s[k].x.getTime ? s[k].x.getTime() : s[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                    ...
                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[k].y) {
                      ...
                      C = r[b] ? r[b] : 0, u = m - C, m = n - C, a.dataSeriesIndexes.length - 1 === f && 1 >= Math.abs(e.x1 - u) && (u = e.x1), r[b] = C + (m - u);
                    b = s[k].color ? s[k].color : y._colorSet[k % y._colorSet.length];
                    ea(c, a.axisY.reversed ? m : u, q, a.axisY.reversed ? u : m, E, b, 0, null, z, false, false, false, y.fillOpacity);
                    b = y.dataPointIds[k];
                    this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: w, dataPointIndex: k, x1: u, y1: q, x2: m, y2: E };
                    b = U(b);
                    v && ea(this._eventManager.ghostCtx, u, q, m, E, b, 0, null, false, false, false, false);
                    (s[k].indexLabel || y.indexLabel || s[k].indexLabelFormatter || y.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: s[k], dataSeries: y, point: { x: 0 <= s[k].y ? m : u, y: q + (E - q) / 2 }, direction: 0 > s[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(u, m), y1: q, x2: Math.max(u, m), y2: E }, color: b });
                  }
              }
            }
            v && (g.drawImage(
        ...
        l.prototype.renderArea = function(a) {
          var g, c;
          function b() {
            C && (0 < f.lineThickness && h.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? E = u : 0 > a.axisY.viewportMaximum ? E = d2.y1 : 0 < a.axisY.viewportMinimum && (E = u), h.lineTo(y, E), h.lineTo(C.x, E), h.closePath(), h.globalAlpha = f.fillOpacity, h.fill(), h.globalAlpha = 1, v && (r.lineTo(y, E), r.lineTo(C.x, E), r.closePath(), r.fill()), h.beginPath(), h.moveTo(
              y,
              s
            ), r.beginPath(), r.moveTo(y, s), C = { x: y, y: s });
          }
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
              ...
              p2 = [];
              g = true;
              var w = 0, y, s, z, u = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), E, C = null;
              if (0 < l2.length) {
                var B = f._colorSet[w % f._colorSet.length], t3 = f.lineColor = f.options.lineColor || B, A3 = t3;
                h.fillStyle = B;
                h.strokeStyle = t3;
                ...
                for (var fa = true; w < l2.length; w++)
                  if (z = l2[w].x.getTime ? l2[w].x.getTime() : l2[w].x, !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax && (!f.connectNullData || !fa)))
                    if ("number" !== typeof l2[w].y)
                      ...
                      g || fa ? (!g && f.connectNullData ? (h.setLineDash && (f.options.nullDataLineDashType || c === f.lineDashType && f.lineDashType !== f.nullDataLineDashType) && (g = y, c = s, y = m.x, s = m.y, b(), h.moveTo(m.x, m.y), y = g, s = c, C = m, c = f.nullDataLineDashType, h.setLineDash(L)), h.lineTo(
                        y,
                        s
                      ), v && r.lineTo(y, s)) : (h.beginPath(), h.moveTo(y, s), v && (r.beginPath(), r.moveTo(y, s)), C = { x: y, y: s }), fa = g = false) : (h.lineTo(y, s), v && r.lineTo(y, s), 0 == w % 250 && b());
                      m = { x: y, y: s };
                      w < l2.length - 1 && (A3 !== (l2[w].lineColor || t3) || c !== (l2[w].lineDashType || f.lineDashType)) && (b(), A3 = l2[w].lineColor || t3, h.strokeStyle = A3, h.setLineDash && (l2[w].lineDashType ? (c = l2[w].lineDashType, h.setLineDash(H(c, f.lineThickness))) : (c = f.lineDashType, h.setLineDash(Q))));
                      ...
                      0 !== l2[w].markerSize && (0 < l2[w].markerSize || 0 < f.markerSize) && (z = f.getMarkerProperties(w, y, s, h), p2.push(z), aa = U(aa), v && p2.push({ x: y, y: s, ctx: r, type: z.type, size: z.size, color: aa, borderColor: aa, borderThickness: z.borderThickness }));
                      (l2[w].indexLabel || f.indexLabel || l2[w].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: l2[w], dataSeries: f, point: { x: y, y: s }, direction: 0 > l2[w].y === a.axisY.reversed ? 1 : -1, color: B });
                    }
                b();
                Y.drawMarkers(p2);
              }
        ...
        l.prototype.renderSplineArea = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var p2 = 0; p2 < a.dataSeriesIndexes.length; p2++) {
              ...
              r = U(r);
              e.fillStyle = r;
              var r = [], n = 0, f, l2, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), y, s = null, z = [];
              if (0 < q.length) {
                ...
                var B = "solid";
                if (b.setLineDash) {
                  var A3 = H(m.nullDataLineDashType, m.lineThickness), B = m.lineDashType, D2 = H(B, m.lineThickness);
                  b.setLineDash(D2);
                }
                for (l2 = false; n < q.length; n++)
                  if (f = q[n].x.getTime ? q[n].x.getTime() : q[n].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !l2)))
                    if ("number" !== typeof q[n].y)
                      0 < n && !l2 && (m.connectNullData ? b.setLineDash && (0 < z.length && (m.options.nullDataLineDashType || !q[n - 1].lineDashType)) && (z[z.length - 1].newLineDashArray = A3, B = m.nullDataLineDashType) : (g(), z = [])), l2 = true;
                    else {
                      ...
                      z[z.length] = { x: f, y: l2 };
                      n < q.length - 1 && (C !== (q[n].lineColor || E) || B !== (q[n].lineDashType || m.lineDashType)) && (C = q[n].lineColor || E, z[z.length - 1].newStrokeStyle = C, b.setLineDash && (q[n].lineDashType ? (B = q[n].lineDashType, z[z.length - 1].newLineDashArray = H(B, m.lineThickness)) : (B = m.lineDashType, z[z.length - 1].newLineDashArray = D2)));
                      if (0 !== q[n].markerSize && (0 < q[n].markerSize || 0 < m.markerSize)) {
                        var Q = m.getMarkerProperties(n, f, l2, b);
                        r.push(Q);
                        L = U(L);
                        v && r.push({ x: f, y: l2, ctx: e, type: Q.type, size: Q.size, color: L, borderColor: L, borderThickness: Q.borderThickness });
                      }
        ...
        l.prototype.renderStepArea = function(a) {
          var g, c;
          function b() {
            C && (0 < f.lineThickness && h.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? E = u : 0 > a.axisY.viewportMaximum ? E = d2.y1 : 0 < a.axisY.viewportMinimum && (E = u), h.lineTo(y, E), h.lineTo(C.x, E), h.closePath(), h.globalAlpha = f.fillOpacity, h.fill(), h.globalAlpha = 1, v && (r.lineTo(y, E), r.lineTo(C.x, E), r.closePath(), r.fill()), h.beginPath(), h.moveTo(y, s), r.beginPath(), r.moveTo(y, s), C = { x: y, y: s });
          }
          var e = a.targetCanvasCtx || this.plotArea.ctx, h = v ? this._preRenderCtx : e;
          if (!(0 >= a.dataSeriesIndexes.length)) {
            var r = this._eventManager.ghostCtx, d2 = a.axisY.lineCoordinates, p2 = [], k = this.plotArea, m;
            ...
            for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
              ...
              if (0 < l2.length) {
                ...
                var L = "solid";
                if (h.setLineDash) {
                  var Q = H(f.nullDataLineDashType, f.lineThickness), L = f.lineDashType, D2 = H(L, f.lineThickness);
                  h.setLineDash(D2);
                }
                for (; w < l2.length; w++)
                  if (z = l2[w].x.getTime ? l2[w].x.getTime() : l2[w].x, !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax && (!f.connectNullData || !c))) {
                    var aa = s;
                    "number" !== typeof l2[w].y ? (f.connectNullData || (c || g) || b(), c = true) : (y = a.axisX.convertValueToPixel(z), s = a.axisY.convertValueToPixel(l2[w].y), g || c ? (!g && f.connectNullData ? (h.setLineDash && (f.options.nullDataLineDashType || L === f.lineDashType && f.lineDashType !== f.nullDataLineDashType) && (g = y, c = s, y = m.x, s = m.y, b(), h.moveTo(m.x, m.y), y = g, s = c, C = m, L = f.nullDataLineDashType, h.setLineDash(Q)), h.lineTo(y, aa), h.lineTo(y, s), v && (r.lineTo(y, aa), r.lineTo(y, s))) : (h.beginPath(), h.moveTo(y, s), v && (r.beginPath(), r.moveTo(y, s)), C = { x: y, y: s }), c = g = false) : (h.lineTo(y, aa), v && r.lineTo(y, aa), h.lineTo(y, s), v && r.lineTo(y, s), 0 == w % 250 && b()), m = { x: y, y: s }, w < l2.length - 1 && (A3 !== (l2[w].lineColor || t3) || L !== (l2[w].lineDashType || f.lineDashType)) && (b(), A3 = l2[w].lineColor || t3, h.strokeStyle = A3, h.setLineDash && (l2[w].lineDashType ? (L = l2[w].lineDashType, h.setLineDash(H(L, f.lineThickness))) : (L = f.lineDashType, h.setLineDash(D2)))), z = f.dataPointIds[w], this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: w, x1: y, y1: s }, 0 !== l2[w].markerSize && (0 < l2[w].markerSize || 0 < f.markerSize) && (aa = f.getMarkerProperties(w, y, s, h), p2.push(aa), z = U(z), v && p2.push({ x: y, y: s, ctx: r, type: aa.type, size: aa.size, color: z, borderColor: z, borderThickness: aa.borderThickness })), (l2[w].indexLabel || f.indexLabel || l2[w].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepArea", dataPoint: l2[w], dataSeries: f, point: { x: y, y: s }, direction: 0 > l2[w].y === a.axisY.reversed ? 1 : -1, color: B }));
                  }
                b();
                Y.drawMarkers(p2);
              }
        ...
        l.prototype.renderStackedArea = function(a) {
          ...
          var c = a.targetCanvasCtx || this.plotArea.ctx, b = v ? this._preRenderCtx : c;
          if (!(0 >= a.dataSeriesIndexes.length)) {
            var e = null, h = null, r = [], d2 = this.plotArea, p2 = [], k = [], m = [], q = [], n = 0, f, l2, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), y = this._eventManager.ghostCtx, s, z, u;
            v && y.beginPath();
            b.save();
            v && y.save();
            b.beginPath();
            ...
            for (var e = [], E = 0; E < a.dataSeriesIndexes.length; E++) {
              var C = a.dataSeriesIndexes[E], B = this.data[C], t3 = B.dataPoints;
              B.dataPointIndexes = [];
              for (n = 0; n < t3.length; n++)
                C = t3[n].x.getTime ? t3[n].x.getTime() : t3[n].x, B.dataPointIndexes[C] = n, e[C] || (m.push(C), e[C] = true);
              m.sort(Sa);
            }
            for (E = 0; E < a.dataSeriesIndexes.length; E++) {
              ...
              k = [];
              n = B.id;
              this._eventManager.objectMap[n] = { objectType: "dataSeries", dataSeriesIndex: C };
              n = U(n);
              y.fillStyle = n;
              if (0 < m.length) {
                var e = B._colorSet[0], A3 = B.lineColor = B.options.lineColor || e, L = A3;
                b.fillStyle = e;
                b.strokeStyle = A3;
                b.lineWidth = B.lineThickness;
                u = "solid";
                if (b.setLineDash) {
                  var Q = H(B.nullDataLineDashType, B.lineThickness);
                  u = B.lineDashType;
                  var D2 = H(u, B.lineThickness);
                  b.setLineDash(D2);
                }
                for (var aa = true, n = 0; n < m.length; n++) {
                  var h = m[n], ha = null, ha = 0 <= B.dataPointIndexes[h] ? t3[B.dataPointIndexes[h]] : { x: h, y: null };
                  if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                    if ("number" !== typeof ha.y)
                      B.connectNullData || (aa || z) || g(), aa = true;
                    else {
                      ...
                      k.push({ x: f, y: w - oa });
                      p2[h] = w - l2;
                      z || aa ? (!z && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || u === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (z = k.pop(), u = k[k.length - 1], g(), b.moveTo(s.x, s.y), k.push(u), k.push(z), u = B.nullDataLineDashType, b.setLineDash(Q)), b.lineTo(f, l2), v && y.lineTo(f, l2)) : (b.beginPath(), b.moveTo(f, l2), v && (y.beginPath(), y.moveTo(f, l2))), aa = z = false) : (b.lineTo(f, l2), v && y.lineTo(f, l2), 0 == n % 250 && (g(), b.moveTo(f, l2), v && y.moveTo(f, l2), k.push({ x: f, y: w - oa })));
                      s = { x: f, y: l2 };
                      n < t3.length - 1 && (L !== (t3[n].lineColor || A3) || u !== (t3[n].lineDashType || B.lineDashType)) && (g(), b.beginPath(), b.moveTo(f, l2), k.push({ x: f, y: w - oa }), L = t3[n].lineColor || A3, b.strokeStyle = L, b.setLineDash && (t3[n].lineDashType ? (u = t3[n].lineDashType, b.setLineDash(H(u, B.lineThickness))) : (u = B.lineDashType, b.setLineDash(D2))));
                      if (0 <= B.dataPointIndexes[h]) {
                        var la = B.dataPointIds[B.dataPointIndexes[h]];
                        this._eventManager.objectMap[la] = { id: la, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: B.dataPointIndexes[h], x1: f, y1: l2 };
                      }
                      0 <= B.dataPointIndexes[h] && 0 !== ha.markerSize && (0 < ha.markerSize || 0 < B.markerSize) && (oa = B.getMarkerProperties(B.dataPointIndexes[h], f, l2, b), r.push(oa), h = U(la), v && r.push({ x: f, y: l2, ctx: y, type: oa.type, size: oa.size, color: h, borderColor: h, borderThickness: oa.borderThickness }));
                      (ha.indexLabel || B.indexLabel || ha.indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea", dataPoint: ha, dataSeries: B, point: { x: f, y: l2 }, direction: 0 > ha.y === a.axisY.reversed ? 1 : -1, color: e });
                    }
                }
                g();
                b.moveTo(f, l2);
        ...
        l.prototype.renderStackedArea100 = function(a) {
          ...
          var c = a.targetCanvasCtx || this.plotArea.ctx, b = v ? this._preRenderCtx : c;
          if (!(0 >= a.dataSeriesIndexes.length)) {
            var e = null, h = null, r = this.plotArea, d2 = [], p2 = [], k = [], m = [], q = [], n = 0, f, l2, w, y, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), u = this._eventManager.ghostCtx;
            b.save();
            v && u.save();
            b.beginPath();
            ...
            for (var e = [], t3 = 0; t3 < a.dataSeriesIndexes.length; t3++) {
              var C = a.dataSeriesIndexes[t3], B = this.data[C], A3 = B.dataPoints;
              B.dataPointIndexes = [];
              for (n = 0; n < A3.length; n++)
                C = A3[n].x.getTime ? A3[n].x.getTime() : A3[n].x, B.dataPointIndexes[C] = n, e[C] || (m.push(C), e[C] = true);
              m.sort(Sa);
            }
            for (t3 = 0; t3 < a.dataSeriesIndexes.length; t3++) {
              C = a.dataSeriesIndexes[t3];
              B = this.data[C];
              A3 = B.dataPoints;
              y = true;
              e = B.id;
              ...
              k = [];
              if (0 < m.length) {
                var e = B._colorSet[n % B._colorSet.length], D2 = B.lineColor = B.options.lineColor || e, L = D2;
                b.fillStyle = e;
                b.strokeStyle = D2;
                b.lineWidth = B.lineThickness;
                s = "solid";
                if (b.setLineDash) {
                  var Q = H(B.nullDataLineDashType, B.lineThickness);
                  s = B.lineDashType;
                  var fa = H(s, B.lineThickness);
                  b.setLineDash(fa);
                }
                for (var aa = true, n = 0; n < m.length; n++) {
                  var h = m[n], ha = null, ha = 0 <= B.dataPointIndexes[h] ? A3[B.dataPointIndexes[h]] : { x: h, y: null };
                  if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                    if ("number" !== typeof ha.y)
                      B.connectNullData || (aa || y) || g(), aa = true;
                    else {
                      var oa;
                      oa = 0 !== a.dataPointYSums[h] ? 100 * (ha.y / a.dataPointYSums[h]) : 0;
                      f = a.axisX.convertValueToPixel(h);
                      var la = p2[h] ? p2[h] : 0;
                      if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                        q[h] = oa + (q[h] ? q[h] : 0);
                      ...
                      k.push({ x: f, y: z - la });
                      p2[h] = z - l2;
                      y || aa ? (!y && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || s === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (y = k.pop(), s = k[k.length - 1], g(), b.moveTo(w.x, w.y), k.push(s), k.push(y), s = B.nullDataLineDashType, b.setLineDash(Q)), b.lineTo(f, l2), v && u.lineTo(f, l2)) : (b.beginPath(), b.moveTo(f, l2), v && (u.beginPath(), u.moveTo(f, l2))), aa = y = false) : (b.lineTo(f, l2), v && u.lineTo(f, l2), 0 == n % 250 && (g(), b.moveTo(f, l2), v && u.moveTo(f, l2), k.push({ x: f, y: z - la })));
                      w = { x: f, y: l2 };
                      n < A3.length - 1 && (L !== (A3[n].lineColor || D2) || s !== (A3[n].lineDashType || B.lineDashType)) && (g(), b.beginPath(), b.moveTo(f, l2), k.push({ x: f, y: z - la }), L = A3[n].lineColor || D2, b.strokeStyle = L, b.setLineDash && (A3[n].lineDashType ? (s = A3[n].lineDashType, b.setLineDash(H(s, B.lineThickness))) : (s = B.lineDashType, b.setLineDash(fa))));
                      if (0 <= B.dataPointIndexes[h]) {
                        var F = B.dataPointIds[B.dataPointIndexes[h]];
                        this._eventManager.objectMap[F] = { id: F, objectType: "dataPoint", dataSeriesIndex: C, dataPointIndex: B.dataPointIndexes[h], x1: f, y1: l2 };
                      }
                      0 <= B.dataPointIndexes[h] && 0 !== ha.markerSize && (0 < ha.markerSize || 0 < B.markerSize) && (la = B.getMarkerProperties(B.dataPointIndexes[h], f, l2, b), d2.push(la), h = U(F), v && d2.push({ x: f, y: l2, ctx: u, type: la.type, size: la.size, color: h, borderColor: h, borderThickness: la.borderThickness }));
                      (ha.indexLabel || B.indexLabel || ha.indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: ha, dataSeries: B, point: { x: f, y: l2 }, direction: 0 > ha.y === a.axisY.reversed ? 1 : -1, color: e });
                    }
                }
                g();
                b.moveTo(f, l2);
        ...
        l.prototype.renderBubble = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var l2 = 25 * Math.PI, w = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, l2), k = 0; k < a.dataSeriesIndexes.length; k++)
              if (m = a.dataSeriesIndexes[k], q = this.data[m], n = q.dataPoints, 0 < n.length) {
                for (c.strokeStyle = "#4572A7 ", e = 0; e < n.length; e++)
                  if (h = n[e].getTime ? h = n[e].x.getTime() : h = n[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                    ...
                    var f = n[e].z, y = 2 * Math.max(Math.sqrt((d2 === p2 ? w / 2 : l2 + (w - l2) / (d2 - p2) * (f - p2)) / Math.PI) << 0, 1), f = q.getMarkerProperties(e, c);
                    f.size = y;
              ...
              if (0 < m.length) {
                ...
                for (var q = 0, n = 0, e = 0; e < m.length; e++)
                  if (h = m[e].getTime ? h = m[e].x.getTime() : h = m[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                    ...
                    c.globalAlpha = 1;
                    Math.sqrt((q - h) * (q - h) + (n - r) * (n - r)) < Math.min(f.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (q = k.dataPointIds[e], this._eventManager.objectMap[q] = { id: q, objectType: "dataPoint", dataSeriesIndex: p2, dataPointIndex: e, x1: h, y1: r }, q = U(q), v && Y.drawMarker(f.x, f.y, this._eventManager.ghostCtx, f.type, f.size, q, q, f.borderThickness), (m[e].indexLabel || k.indexLabel || m[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                      chartType: "scatter",
                      dataPoint: m[e],
                      dataSeries: k,
                      point: { x: h, y: r },
              ...
              if (0 < z.length) {
                for (var u = 5 < t3 && s.bevelEnabled ? true : false, d2 = 0; d2 < z.length; d2++)
                  if (z[d2].getTime ? f = z[d2].x.getTime() : f = z[d2].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !p(z[d2].y) && z[d2].y.length && "number" === typeof z[d2].y[0] && "number" === typeof z[d2].y[1] && "number" === typeof z[d2].y[2] && "number" === typeof z[d2].y[3]) {
                    ...
                    var E = l2 - t3 / 2 << 0, C = E + t3 << 0, h = s.options.fallingColor ? s.fallingColor : s._colorSet[0], e = z[d2].color ? z[d2].color : s._colorSet[0], B = Math.round(Math.max(1, 0.15 * t3)), A3 = 0 === B % 2 ? 0 : 0.5, D2 = s.dataPointIds[d2];
                    this._eventManager.objectMap[D2] = { id: D2, objectType: "dataPoint", dataSeriesIndex: y, dataPointIndex: d2, x1: E, y1: k, x2: C, y2: m, x3: l2, y3: q, x4: l2, y4: n, borderThickness: B, color: e };
                    c.strokeStyle = e;
                    c.beginPath();
                    c.lineWidth = B;
                    b.lineWidth = Math.max(B, 4);
                    "candlestick" === s.type ? (c.moveTo(l2 - A3, m), c.lineTo(l2 - A3, Math.min(k, n)), c.stroke(), c.moveTo(l2 - A3, Math.max(k, n)), c.lineTo(l2 - A3, q), c.stroke(), ea(c, E, Math.min(k, n), C, Math.max(k, n), z[d2].y[0] <= z[d2].y[3] ? s.risingColor : h, B, e, u, u, false, false, s.fillOpacity), v && (e = U(D2), b.strokeStyle = e, b.moveTo(l2 - A3, m), b.lineTo(l2 - A3, Math.min(
                      k,
                      n
                    )), b.stroke(), b.moveTo(l2 - A3, Math.max(k, n)), b.lineTo(l2 - A3, q), b.stroke(), ea(b, E, Math.min(k, n), C, Math.max(k, n), e, 0, null, false, false, false, false))) : "ohlc" === s.type && (c.moveTo(l2 - A3, m), c.lineTo(l2 - A3, q), c.stroke(), c.beginPath(), c.moveTo(l2, k), c.lineTo(E, k), c.stroke(), c.beginPath(), c.moveTo(l2, n), c.lineTo(C, n), c.stroke(), v && (e = U(D2), b.strokeStyle = e, b.moveTo(l2 - A3, m), b.lineTo(l2 - A3, q), b.stroke(), b.beginPath(), b.moveTo(l2, k), b.lineTo(E, k), b.stroke(), b.beginPath(), b.moveTo(l2, n), b.lineTo(C, n), b.stroke()));
                    (z[d2].indexLabel || s.indexLabel || z[d2].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({ chartType: s.type, dataPoint: z[d2], dataSeries: s, point: { x: E + (C - E) / 2, y: a.axisY.reversed ? q : m }, direction: 1, bounds: { x1: E, y1: Math.min(m, q), x2: C, y2: Math.max(m, q) }, color: e });
                  }
              }
            }
              ...
              if (0 < u.length) {
                for (var E = 5 < t3 && z.bevelEnabled ? true : false, r = 0; r < u.length; r++)
                  if (u[r].getTime ? f = u[r].x.getTime() : f = u[r].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !p(u[r].y) && u[r].y.length && "number" === typeof u[r].y[0] && "number" === typeof u[r].y[1] && "number" === typeof u[r].y[2] && "number" === typeof u[r].y[3] && "number" === typeof u[r].y[4] && 5 === u[r].y.length) {
                    ...
                    var C = d2 - t3 / 2 << 0, B = d2 + t3 / 2 << 0, e = u[r].color ? u[r].color : z._colorSet[0], A3 = Math.round(Math.max(1, 0.15 * t3)), D2 = 0 === A3 % 2 ? 0 : 0.5, L = u[r].whiskerColor ? u[r].whiskerColor : u[r].color ? z.whiskerColor ? z.whiskerColor : u[r].color : z.whiskerColor ? z.whiskerColor : e, Q = "number" === typeof u[r].whiskerThickness ? u[r].whiskerThickness : "number" === typeof z.options.whiskerThickness ? z.whiskerThickness : A3, fa = u[r].whiskerDashType ? u[r].whiskerDashType : z.whiskerDashType, aa = p(u[r].whiskerLength) ? p(z.options.whiskerLength) ? t3 : z.whiskerLength : u[r].whiskerLength, aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= t3 ? t3 : aa : "string" === typeof aa ? parseInt(aa) * t3 / 100 > t3 ? t3 : parseInt(aa) * t3 / 100 : t3, ha = 1 === Math.round(Q) % 2 ? 0.5 : 0, oa = u[r].stemColor ? u[r].stemColor : u[r].color ? z.stemColor ? z.stemColor : u[r].color : z.stemColor ? z.stemColor : e, la = "number" === typeof u[r].stemThickness ? u[r].stemThickness : "number" === typeof z.options.stemThickness ? z.stemThickness : A3, F = 1 === Math.round(la) % 2 ? 0.5 : 0, I2 = u[r].stemDashType ? u[r].stemDashType : z.stemDashType, K2 = u[r].lineColor ? u[r].lineColor : u[r].color ? z.lineColor ? z.lineColor : u[r].color : z.lineColor ? z.lineColor : e, P2 = "number" === typeof u[r].lineThickness ? u[r].lineThickness : "number" === typeof z.options.lineThickness ? z.lineThickness : A3, S3 = u[r].lineDashType ? u[r].lineDashType : z.lineDashType, M = 1 === Math.round(P2) % 2 ? 0.5 : 0, O2 = z.upperBoxColor, T = z.lowerBoxColor, ua = p(z.options.fillOpacity) ? 1 : z.fillOpacity, R = z.dataPointIds[r];
                    ...
                    c.save();
                    0 < la && (c.beginPath(), c.strokeStyle = oa, c.lineWidth = la, c.setLineDash && c.setLineDash(H(I2, la)), c.moveTo(d2 - F, k), c.lineTo(d2 - F, l2), c.stroke(), c.moveTo(d2 - F, q), c.lineTo(d2 - F, m), c.stroke());
                    c.restore();
                    b.lineWidth = Math.max(A3, 4);
                    c.beginPath();
                    ea(c, C, Math.min(n, k), B, Math.max(k, n), T, 0, e, w ? E : false, w ? false : E, false, false, ua);
                    c.beginPath();
                    ea(c, C, Math.min(m, n), B, Math.max(n, m), O2, 0, e, w ? false : E, w ? E : false, false, false, ua);
                    c.beginPath();
                    c.lineWidth = A3;
                    c.strokeStyle = e;
                    c.rect(C - D2, Math.min(k, m) - D2, B - C + 2 * D2, Math.max(k, m) - Math.min(k, m) + 2 * D2);
                    c.stroke();
                    c.save();
                    0 < P2 && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(H(S3, P2)), c.strokeStyle = K2, c.lineWidth = P2, c.moveTo(C, n - M), c.lineTo(B, n - M), c.stroke());
                    c.restore();
                    c.save();
                    ...
                    c.restore();
                    v && (e = U(R), b.strokeStyle = e, b.lineWidth = la, 0 < la && (b.moveTo(d2 - D2 - F, k), b.lineTo(d2 - D2 - F, Math.max(l2, q)), b.stroke(), b.moveTo(d2 - D2 - F, Math.min(l2, q)), b.lineTo(d2 - D2 - F, m), b.stroke()), ea(b, C, Math.max(k, m), B, Math.min(k, m), e, 0, null, false, false, false, false), 0 < Q && (b.beginPath(), b.lineWidth = Q, b.moveTo(d2 + aa / 2, q - ha), b.lineTo(d2 - aa / 2, q - ha), b.stroke(), b.moveTo(d2 + aa / 2, l2 + ha), b.lineTo(d2 - aa / 2, l2 + ha), b.stroke()));
                    (u[r].indexLabel || z.indexLabel || u[r].indexLabelFormatter || z.indexLabelFormatter) && this._indexLabels.push({ chartType: z.type, dataPoint: u[r], dataSeries: z, point: { x: C + (B - C) / 2, y: a.axisY.reversed ? l2 : q }, direction: 1, bounds: { x1: C, y1: Math.min(l2, q), x2: B, y2: Math.max(l2, q) }, color: e });
                  }
              }
            }
            v && (g.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(
        ...
        l.prototype.renderRangeColumn = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
              ...
              if (0 < f.length) {
                for (var t3 = 5 < k && n.bevelEnabled ? true : false, h = 0; h < f.length; h++)
                  if (f[h].getTime ? l2 = f[h].x.getTime() : l2 = f[h].x, !(l2 < a.axisX.dataInfo.viewPortMin || l2 > a.axisX.dataInfo.viewPortMax) && !p(f[h].y) && f[h].y.length && "number" === typeof f[h].y[0] && "number" === typeof f[h].y[1]) {
                    ...
                    var w = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + m) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + m) * k << 0, y = a.axisX.reversed ? w - k << 0 : w + k << 0, b = f[h].color ? f[h].color : n._colorSet[h % n._colorSet.length];
                    if (r > d2) {
                      var s = r;
                      r = d2;
                      d2 = s;
                    ...
                    s = n.dataPointIds[h];
                    this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: w, y1: r, x2: y, y2: d2 };
                    ea(c, a.axisX.reversed ? y : w, r, a.axisX.reversed ? w : y, d2, b, 0, b, t3, t3, false, false, n.fillOpacity);
                    b = U(s);
                    v && ea(this._eventManager.ghostCtx, a.axisX.reversed ? y : w, r, a.axisX.reversed ? w : y, d2, b, 0, null, false, false, false, false);
                    if (f[h].indexLabel || n.indexLabel || f[h].indexLabelFormatter || n.indexLabelFormatter)
                      this._indexLabels.push({ chartType: "rangeColumn", dataPoint: f[h], dataSeries: n, indexKeyword: 0, point: { x: w + (y - w) / 2, y: f[h].y[1] >= f[h].y[0] ? d2 : r }, direction: f[h].y[1] >= f[h].y[0] ? -1 : 1, bounds: { x1: w, y1: Math.min(r, d2), x2: y, y2: Math.max(r, d2) }, color: b }), this._indexLabels.push({ chartType: "rangeColumn", dataPoint: f[h], dataSeries: n, indexKeyword: 1, point: { x: w + (y - w) / 2, y: f[h].y[1] >= f[h].y[0] ? r : d2 }, direction: f[h].y[1] >= f[h].y[0] ? 1 : -1, bounds: { x1: w, y1: Math.min(r, d2), x2: y, y2: Math.max(r, d2) }, color: b });
                  }
              }
            }
            v && (g.drawImage(
        ...
        l.prototype.renderError = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            var e = null, h = false, r = this.plotArea, d2 = 0, l2, k, m, q, n, f, t3, w = a.axisX.dataInfo.minDiff;
            ...
            for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
              var u = a.dataSeriesIndexes[z], E = this.data[u], C = E.dataPoints, B = p(E._linkedSeries) ? false : E._linkedSeries.type.match(/(bar|column)/ig) && E._linkedSeries.visible ? true : false, D2 = 0;
              if (B)
              ...
              d2 = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? y : 1))) << 0 : 0.3 * this.width;
              h && (d2 = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? y : 1))) << 0 : 0.03 * this.width);
              s = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? r.height : r.width) * (a.axisX.logarithmic ? Math.log(w) / Math.log(a.axisX.range) : Math.abs(w) / Math.abs(a.axisX.range)) / (B ? y : 1)) << 0;
              ...
              s > d2 && (s = d2);
              if (0 < C.length)
                for (var H2 = E._colorSet, d2 = 0; d2 < C.length; d2++) {
                  var e = E.lineColor = E.options.color ? E.options.color : H2[0], L = {
                    color: C[d2].whiskerColor ? C[d2].whiskerColor : C[d2].color ? E.whiskerColor ? E.whiskerColor : C[d2].color : E.whiskerColor ? E.whiskerColor : e,
                    thickness: p(C[d2].whiskerThickness) ? E.whiskerThickness : C[d2].whiskerThickness,
                    dashType: C[d2].whiskerDashType ? C[d2].whiskerDashType : E.whiskerDashType,
                    length: p(C[d2].whiskerLength) ? p(E.options.whiskerLength) ? s : E.options.whiskerLength : C[d2].whiskerLength,
                    trimLength: p(C[d2].whiskerLength) ? p(E.options.whiskerLength) ? 50 : 0 : 0
                  };
                  ...
                  var Q = { color: C[d2].stemColor ? C[d2].stemColor : C[d2].color ? E.stemColor ? E.stemColor : C[d2].color : E.stemColor ? E.stemColor : e, thickness: C[d2].stemThickness ? C[d2].stemThickness : E.stemThickness, dashType: C[d2].stemDashType ? C[d2].stemDashType : E.stemDashType };
                  Q.thickness = "number" === typeof Q.thickness ? 0 > Q.thickness ? 0 : Math.round(Q.thickness) : 2;
                  C[d2].getTime ? t3 = C[d2].x.getTime() : t3 = C[d2].x;
                  if (!(t3 < a.axisX.dataInfo.viewPortMin || t3 > a.axisX.dataInfo.viewPortMax) && !p(C[d2].y) && C[d2].y.length && "number" === typeof C[d2].y[0] && "number" === typeof C[d2].y[1]) {
                    var fa = a.axisX.convertValueToPixel(t3);
                    b ? k = fa : l2 = fa;
                    fa = a.axisY.convertValueToPixel(C[d2].y[0]);
                    b ? m = fa : n = fa;
                    fa = a.axisY.convertValueToPixel(C[d2].y[1]);
                    b ? q = fa : f = fa;
                    b ? (n = a.axisX.reversed ? k + (B ? y : 1) * s / 2 - (B ? D2 - 1 : 0) * s << 0 : k - (B ? y : 1) * s / 2 + (B ? D2 - 1 : 0) * s << 0, f = a.axisX.reversed ? n - s << 0 : n + s << 0) : (m = a.axisX.reversed ? l2 + (B ? y : 1) * s / 2 - (B ? D2 - 1 : 0) * s << 0 : l2 - (B ? y : 1) * s / 2 + (B ? D2 - 1 : 0) * s << 0, q = a.axisX.reversed ? m - s << 0 : m + s << 0);
                    !b && n > f && (fa = n, n = f, f = fa);
                    b && m > q && (fa = m, m = q, q = fa);
                    fa = E.dataPointIds[d2];
                    this._eventManager.objectMap[fa] = { id: fa, objectType: "dataPoint", dataSeriesIndex: u, dataPointIndex: d2, x1: Math.min(m, q), y1: Math.min(n, f), x2: Math.max(q, m), y2: Math.max(f, n), isXYSwapped: b, stemProperties: Q, whiskerProperties: L };
                    A2(
                      c,
                      Math.min(m, q),
                      Math.min(n, f),
                    ...
                    v && A2(this._eventManager.ghostCtx, m, n, q, f, e, L, Q, b);
                    if (C[d2].indexLabel || E.indexLabel || C[d2].indexLabelFormatter || E.indexLabelFormatter)
                      this._indexLabels.push({ chartType: "error", dataPoint: C[d2], dataSeries: E, indexKeyword: 0, point: { x: b ? C[d2].y[1] >= C[d2].y[0] ? m : q : m + (q - m) / 2, y: b ? n + (f - n) / 2 : C[d2].y[1] >= C[d2].y[0] ? f : n }, direction: C[d2].y[1] >= C[d2].y[0] ? -1 : 1, bounds: { x1: b ? Math.min(m, q) : m, y1: b ? n : Math.min(n, f), x2: b ? Math.max(m, q) : q, y2: b ? f : Math.max(n, f) }, color: e, axisSwapped: b }), this._indexLabels.push({ chartType: "error", dataPoint: C[d2], dataSeries: E, indexKeyword: 1, point: { x: b ? C[d2].y[1] >= C[d2].y[0] ? q : m : m + (q - m) / 2, y: b ? n + (f - n) / 2 : C[d2].y[1] >= C[d2].y[0] ? n : f }, direction: C[d2].y[1] >= C[d2].y[0] ? 1 : -1, bounds: { x1: b ? Math.min(m, q) : m, y1: b ? n : Math.min(n, f), x2: b ? Math.max(m, q) : q, y2: b ? f : Math.max(n, f) }, color: e, axisSwapped: b });
                  }
                }
            }
              ...
              if (0 < t3.length) {
                ...
                for (h = 0; h < t3.length; h++)
                  if (t3[h].getTime ? k = t3[h].x.getTime() : k = t3[h].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !p(t3[h].y) && t3[h].y.length && "number" === typeof t3[h].y[0] && "number" === typeof t3[h].y[1]) {
                    ...
                    ea(c, r, a.axisX.reversed ? y : l2, d2, a.axisX.reversed ? l2 : y, b, 0, null, w, false, false, false, f.fillOpacity);
                    b = f.dataPointIds[h];
                    this._eventManager.objectMap[b] = {
                      id: b,
                      objectType: "dataPoint",
                    ...
                    b = U(b);
                    v && ea(this._eventManager.ghostCtx, r, a.axisX.reversed ? y : l2, d2, a.axisX.reversed ? l2 : y, b, 0, null, false, false, false, false);
                    if (t3[h].indexLabel || f.indexLabel || t3[h].indexLabelFormatter || f.indexLabelFormatter)
                      this._indexLabels.push({ chartType: "rangeBar", dataPoint: t3[h], dataSeries: f, indexKeyword: 0, point: { x: t3[h].y[1] >= t3[h].y[0] ? r : d2, y: l2 + (y - l2) / 2 }, direction: t3[h].y[1] >= t3[h].y[0] ? -1 : 1, bounds: { x1: Math.min(r, d2), y1: l2, x2: Math.max(r, d2), y2: y }, color: b }), this._indexLabels.push({
                        chartType: "rangeBar",
                        dataPoint: t3[h],
                        dataSeries: f,
                        indexKeyword: 1,
                        point: { x: t3[h].y[1] >= t3[h].y[0] ? d2 : r, y: l2 + (y - l2) / 2 },
                        direction: t3[h].y[1] >= t3[h].y[0] ? 1 : -1,
                        bounds: { x1: Math.min(r, d2), y1: l2, x2: Math.max(r, d2), y2: y },
                        color: b
                      });
                  }
              }
        ...
        l.prototype.renderRangeArea = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d2 = 0; d2 < a.dataSeriesIndexes.length; d2++) {
              ...
              h = U(h);
              e.fillStyle = h;
              var h = [], n = true, f = 0, l2, w, y, s, z = null;
              if (0 < q.length) {
                var u = m._colorSet[f % m._colorSet.length], t3 = m.lineColor = m.options.lineColor || u, C = t3;
                b.fillStyle = u;
                b.strokeStyle = t3;
                b.lineWidth = m.lineThickness;
                var B = "solid";
                if (b.setLineDash) {
                  var A3 = H(
                    ...
                    m.lineThickness
                  ), B = m.lineDashType, D2 = H(B, m.lineThickness);
                  b.setLineDash(D2);
                }
                for (var L = true; f < q.length; f++)
                  if (s = q[f].x.getTime ? q[f].x.getTime() : q[f].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !L)))
                    if (null !== q[f].y && q[f].y.length && "number" === typeof q[f].y[0] && "number" === typeof q[f].y[1]) {
                      ...
                      y = a.axisY.convertValueToPixel(q[f].y[1]);
                      n || L ? (m.connectNullData && !n ? (b.setLineDash && (m.options.nullDataLineDashType || B === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (p2[p2.length - 1].newLineDashArray = D2, B = m.nullDataLineDashType, b.setLineDash(A3)), b.lineTo(l2, w), v && e.lineTo(l2, w), p2.push({ x: l2, y1: w, y2: y })) : (b.beginPath(), b.moveTo(l2, w), z = { x: l2, y: w }, p2 = [], p2.push({ x: l2, y1: w, y2: y }), v && (e.beginPath(), e.moveTo(l2, w))), L = n = false) : (b.lineTo(l2, w), p2.push({ x: l2, y1: w, y2: y }), v && e.lineTo(l2, w), 0 == f % 250 && g());
                      s = m.dataPointIds[f];
                      this._eventManager.objectMap[s] = {
                        id: s,
                        objectType: "dataPoint",
                      ...
                      f < q.length - 1 && (C !== (q[f].lineColor || t3) || B !== (q[f].lineDashType || m.lineDashType)) && (g(), C = q[f].lineColor || t3, p2[p2.length - 1].newStrokeStyle = C, b.strokeStyle = C, b.setLineDash && (q[f].lineDashType ? (B = q[f].lineDashType, p2[p2.length - 1].newLineDashArray = H(B, m.lineThickness), b.setLineDash(p2[p2.length - 1].newLineDashArray)) : (B = m.lineDashType, p2[p2.length - 1].newLineDashArray = D2, b.setLineDash(D2))));
                      if (0 !== q[f].markerSize && (0 < q[f].markerSize || 0 < m.markerSize)) {
                        var Q = m.getMarkerProperties(f, l2, y, b);
                        h.push(Q);
                        var fa = U(s);
                        v && h.push({ x: l2, y, ctx: e, type: Q.type, size: Q.size, color: fa, borderColor: fa, borderThickness: Q.borderThickness });
                        Q = m.getMarkerProperties(f, l2, w, b);
                        h.push(Q);
                        fa = U(s);
                        v && h.push({ x: l2, y: w, ctx: e, type: Q.type, size: Q.size, color: fa, borderColor: fa, borderThickness: Q.borderThickness });
                      }
                      if (q[f].indexLabel || m.indexLabel || q[f].indexLabelFormatter || m.indexLabelFormatter)
                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: q[f], dataSeries: m, indexKeyword: 0, point: { x: l2, y: w }, direction: q[f].y[0] > q[f].y[1] === a.axisY.reversed ? -1 : 1, color: u }), this._indexLabels.push({ chartType: "rangeArea", dataPoint: q[f], dataSeries: m, indexKeyword: 1, point: { x: l2, y }, direction: q[f].y[0] > q[f].y[1] === a.axisY.reversed ? 1 : -1, color: u });
                    } else
                      L || n || g(), L = true;
                g();
                Y.drawMarkers(h);
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d2 = 0; d2 < a.dataSeriesIndexes.length; d2++) {
              ...
              if (0 < m.length) {
                ...
                var E = "solid", C;
                if (b.setLineDash) {
                  var B = H(k.nullDataLineDashType, k.lineThickness), E = k.lineDashType;
                ...
                for (f = false; q < m.length; q++)
                  if (n = m[q].x.getTime ? m[q].x.getTime() : m[q].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !f)))
                    if (null !== m[q].y && m[q].y.length && "number" === typeof m[q].y[0] && "number" === typeof m[q].y[1]) {
                      ...
                      this._eventManager.objectMap[A3] = { id: A3, objectType: "dataPoint", dataSeriesIndex: p2, dataPointIndex: q, x1: n, y1: f, y2: l2 };
                      w[w.length] = { x: n, y: f };
                      y[y.length] = { x: n, y: l2 };
                      q < m.length - 1 && (u !== (m[q].lineColor || z) || E !== (m[q].lineDashType || k.lineDashType)) && (u = m[q].lineColor || z, w[w.length - 1].newStrokeStyle = u, b.setLineDash && (m[q].lineDashType ? (E = m[q].lineDashType, w[w.length - 1].newLineDashArray = H(E, k.lineThickness)) : (E = k.lineDashType, w[w.length - 1].newLineDashArray = C)));
                      if (0 !== m[q].markerSize && (0 < m[q].markerSize || 0 < k.markerSize)) {
                        var D2 = k.getMarkerProperties(q, n, f, b);
                        h.push(D2);
                        var L = U(A3);
                        v && h.push({ x: n, y: f, ctx: e, type: D2.type, size: D2.size, color: L, borderColor: L, borderThickness: D2.borderThickness });
                        D2 = k.getMarkerProperties(q, n, l2, b);
                        h.push(D2);
                        L = U(A3);
                        v && h.push({ x: n, y: l2, ctx: e, type: D2.type, size: D2.size, color: L, borderColor: L, borderThickness: D2.borderThickness });
                      }
                      ...
                      0 < q && !f && (k.connectNullData ? b.setLineDash && (0 < w.length && (k.options.nullDataLineDashType || !m[q - 1].lineDashType)) && (w[w.length - 1].newLineDashArray = B, E = k.nullDataLineDashType) : (g(C, z), w = [], y = [])), f = true;
                g(C, z);
                Y.drawMarkers(h);
              }
            }
        ...
        l.prototype.renderWaterfall = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
              ...
              if (0 < y.length)
                for (var u = 5 < n && w.bevelEnabled ? true : false, t3 = false, C = null, B = null, r = 0; r < y.length; r++)
                  if (y[r].getTime ? m = y[r].x.getTime() : m = y[r].x, "number" !== typeof y[r].y) {
                    ...
                    ea(c, a.axisX.reversed ? D2 : d2, a.axisY.reversed ? k : p2, a.axisX.reversed ? d2 : D2, a.axisY.reversed ? p2 : k, L, 0, L, u, u, false, false, w.fillOpacity);
                    e = U(e);
                    v && ea(this._eventManager.ghostCtx, a.axisX.reversed ? D2 : d2, p2, a.axisX.reversed ? d2 : D2, k, e, 0, null, false, false, false, false);
                    var Q, L = d2;
                    ...
                    0 < r && C && (!t3 || w.connectNullData) && (t3 && c.setLineDash && c.setLineDash(H(A3, s)), c.beginPath(), c.moveTo(C, B - z), c.lineTo(L, Q - z), 0 < s && c.stroke(), v && (b.beginPath(), b.moveTo(
                      C,
                      B - z
                    ), b.lineTo(L, Q - z), 0 < s && b.stroke()));
                    t3 = false;
                    C = D2;
                    B = 0 < y[r].y ? p2 : k;
                    ...
                    (y[r].indexLabel || w.indexLabel || y[r].indexLabelFormatter || w.indexLabelFormatter) && this._indexLabels.push({
                      ...
                      dataPoint: y[r],
                      dataSeries: w,
                      point: { x: d2 + (D2 - d2) / 2, y: 0 <= y[r].y ? p2 : k },
        ...
        var qa2 = function(a, g, c, b, e, h, r, d2, p2) {
          if (!(0 > c)) {
        ...
        l.prototype.renderPie = function(a) {
          function g() {
            if (k && m) {
              ...
              for (var g2 = 0; g2 < m.length; g2++) {
                ...
                var d3 = f[g2], q2 = { percent: null, total: null }, x = null, q2 = l2.getPercentAndTotal(k, h2);
                if (k.indexLabelFormatter || h2.indexLabelFormatter)
                  x = { chart: l2.options, dataSeries: k, dataPoint: h2, total: q2.total, percent: q2.percent };
                q2 = h2.indexLabelFormatter ? h2.indexLabelFormatter(x) : h2.indexLabel ? l2.replaceKeywordsWithValue(h2.indexLabel, h2, k, g2) : k.indexLabelFormatter ? k.indexLabelFormatter(x) : k.indexLabel ? l2.replaceKeywordsWithValue(k.indexLabel, h2, k, g2) : h2.label ? h2.label : "";
                ...
                d3.indexLabelTextBlock = new ka(l2.plotArea.ctx, {
          ...
          function c(a2, b2) {
            ...
            for (c2 = 0; c2 < m.length; c2++) {
              ...
              if (e2 > g2) {
                var h2 = 0.07 * B * Math.cos(f[c2].midAngle), d3 = 0.07 * B * Math.sin(f[c2].midAngle), r2 = false;
                if (m[c2].exploded) {
                ...
                qa2(l2.plotArea.ctx, f[c2].center, f[c2].radius, m[c2].color ? m[c2].color : k._colorSet[c2 % k._colorSet.length], k.type, g2, e2, k.fillOpacity, f[c2].percentInnerRadius);
              }
            }
            c2 = l2.plotArea.ctx;
            c2.save();
          ...
          function h(a2, c2, g2) {
            ...
            if (0 <= a2 && a2 < m.length) {
              ...
              p2 = u.x + B * Math.cos(n2.midAngle);
              q2 = u.y + B * Math.sin(n2.midAngle);
              q2 = Math.sqrt(Math.pow(r2 - p2, 2) + Math.pow(c2 - q2, 2));
              p2 = Math.acos(B / w);
              q2 = Math.acos((w * w + B * B - q2 * q2) / (2 * B * w));
          ...
          function r() {
            ...
            for (var c2 = a2 = 0, g2 = 0, r2 = true, c2 = 0; 10 > c2 && (1 > c2 || 0 < g2); c2++) {
              if (k.radius || !k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && B - g2 <= A3)
                r2 = false;
              r2 && (B -= g2);
              g2 = 0;
              if ("inside" !== k.indexLabelPlacement) {
                ...
                for (var p2, s2, a2 = 0; a2 < m.length; a2++) {
                  ...
                  if (null !== x) {
                    ...
                    if (0 > t4) {
                      for (var C2 = s2 = 0, E = 0; E < m.length; E++)
                        E !== a2 && f[E].hemisphere === d3.hemisphere && (f[E].indexLabelTextBlock.y < d3.indexLabelTextBlock.y ? s2++ : C2++);
                      s2 = t4 / (s2 + C2 || 1) * C2;
                      var C2 = -1 * (t4 - s2), H2 = E = 0;
                      "right" === d3.hemisphere ? (E = h(a2, s2), C2 = -1 * (t4 - E), H2 = h(x, C2), +H2.toFixed(z) < +C2.toFixed(z) && +E.toFixed(z) <= +s2.toFixed(z) && h(a2, -(C2 - H2))) : (E = h(x, s2), C2 = -1 * (t4 - E), H2 = h(a2, C2), +H2.toFixed(z) < +C2.toFixed(z) && +E.toFixed(z) <= +s2.toFixed(z) && h(x, -(C2 - H2)));
                    }
                  }
                }
              } else
                for (a2 = 0; a2 < m.length; a2++)
                  d3 = f[a2], w = "pie" === k.type ? 0.7 * B : 0.85 * B, x = u.x + w * Math.cos(d3.midAngle), s2 = u.y + w * Math.sin(d3.midAngle), d3.indexLabelTextBlock.x = x, d3.indexLabelTextBlock.y = s2;
              for (a2 = 0; a2 < m.length; a2++)
                if (d3 = f[a2], x = d3.indexLabelTextBlock.measureText(), 0 !== x.height && 0 !== x.width)
                  x = x = 0, "right" === d3.hemisphere ? (x = n.x2 - (d3.indexLabelTextBlock.x + d3.indexLabelTextBlock.width + q), x *= -1) : x = n.x1 - (d3.indexLabelTextBlock.x - d3.indexLabelTextBlock.width - q), 0 < x && (!r2 && d3.indexLabelText && (s2 = "right" === d3.hemisphere ? n.x2 - d3.indexLabelTextBlock.x : d3.indexLabelTextBlock.x - n.x1, 0.3 * d3.indexLabelTextBlock.maxWidth > s2 ? d3.indexLabelText = "" : d3.indexLabelTextBlock.maxWidth = 0.85 * s2, 0.3 * d3.indexLabelTextBlock.maxWidth < s2 && (d3.indexLabelTextBlock.x -= "right" === d3.hemisphere ? 2 : -2)), Math.abs(d3.indexLabelTextBlock.y - d3.indexLabelTextBlock.height / 2 - u.y) < B || Math.abs(d3.indexLabelTextBlock.y + d3.indexLabelTextBlock.height / 2 - u.y) < B) && (x /= Math.abs(Math.cos(d3.indexLabelAngle)), 9 < x && (x *= 0.3), x > g2 && (g2 = x)), x = x = 0, 0 < d3.indexLabelAngle && d3.indexLabelAngle < Math.PI ? (x = n.y2 - (d3.indexLabelTextBlock.y + d3.indexLabelTextBlock.height / 2 + 5), x *= -1) : x = n.y1 - (d3.indexLabelTextBlock.y - d3.indexLabelTextBlock.height / 2 - 5), 0 < x && (!r2 && d3.indexLabelText && (s2 = 0 < d3.indexLabelAngle && d3.indexLabelAngle < Math.PI ? -1 : 1, 0 === h(a2, x * s2) && h(a2, 2 * s2)), Math.abs(d3.indexLabelTextBlock.x - u.x) < B && (x /= Math.abs(Math.sin(d3.indexLabelAngle)), 9 < x && (x *= 0.3), x > g2 && (g2 = x)));
                  ...
                  if (h2 = false, p2 = f[d4], p2.indexLabelText) {
                    ...
                    if (null !== r3) {
                      ...
                      if (n2 = 0 > t4) {
                        ...
                        var l3 = p2.indexLabelTextBlock.y - p2.indexLabelTextBlock.height / 2, x2 = p2.indexLabelTextBlock.y + p2.indexLabelTextBlock.height / 2, s3 = k2.indexLabelTextBlock.y - k2.indexLabelTextBlock.height / 2, u2 = k2.indexLabelTextBlock.x + k2.indexLabelTextBlock.width, w2 = k2.indexLabelTextBlock.y + k2.indexLabelTextBlock.height / 2;
                        n2 = p2.indexLabelTextBlock.x + p2.indexLabelTextBlock.width < k2.indexLabelTextBlock.x - q || n2 > u2 + q || l3 > w2 + q || x2 < s3 - q ? false : true;
                      }
          ...
          var l2 = this;
          if (!(0 >= a.dataSeriesIndexes.length)) {
            var k = this.data[a.dataSeriesIndexes[0]], m = k.dataPoints, q = 10, n = this.plotArea, f = k.dataPointEOs, v2 = 2, w, y = 1.3, s = 20 / 180 * Math.PI, z = 6, u = { x: (n.x2 + n.x1) / 2, y: (n.y2 + n.y1) / 2 }, t3 = 0;
            a = false;
            for (var C = 0; C < m.length; C++)
              t3 += Math.abs(m[C].y), !a && ("undefined" !== typeof m[C].indexLabel && null !== m[C].indexLabel && 0 < m[C].indexLabel.toString().length) && (a = true), !a && ("undefined" !== typeof m[C].label && null !== m[C].label && 0 < m[C].label.toString().length) && (a = true);
            if (0 !== t3) {
              a = a || "undefined" !== typeof k.indexLabel && null !== k.indexLabel && 0 < k.indexLabel.toString().length;
              var B = "inside" !== k.indexLabelPlacement && a ? 0.75 * Math.min(n.width, n.height) / 2 : 0.92 * Math.min(n.width, n.height) / 2;
              k.radius && (B = Ua(k.radius, B));
              var A3 = "undefined" !== typeof k.innerRadius && null !== k.innerRadius ? Ua(k.innerRadius, B) : 0.7 * B;
              k.radius = B;
              "doughnut" === k.type && (k.innerRadius = A3);
              var D2 = Math.min(A3 / B, (B - 1) / B);
              ...
              this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a2) {
                ...
                for (var b2 = f[0].startAngle + 2 * Math.PI * a2, c2 = 0; c2 < m.length; c2++) {
                  ...
                  e2 > g2 && qa2(l2.plotArea.ctx, f[c2].center, f[c2].radius, r2, k.type, g2, e2, k.fillOpacity, f[c2].percentInnerRadius);
                  if (h2)
                    break;
                }
                d2();
        ...
        l.prototype.renderFunnel = function(a) {
          ...
          function c() {
            var a2 = X3, b2 = Z2, c2 = M, e2 = ba, g2, f2;
            g2 = P2;
            f2 = S3 - O2;
            ...
            if (0 === h2)
              return -1;
            for (var r = e2[0] = 0, k2 = 0, m2, n2, b2 = b2 - a2, r = false, d3 = 0; d3 < z.length; d3++)
              a2 = Math.abs(z[d3].y) * f2 / h2, r ? m2 = 0 == Number(c2.toFixed(3)) ? 0 : a2 / c2 : (n2 = ca3 * ca3 * b2 * b2 - 4 * Math.abs(ca3) * a2, 0 > n2 ? (n2 = c2, r = (b2 + n2) * (g2 - k2) / 2, a2 -= r, m2 = g2 - k2, k2 += g2 - k2, m2 += 0 == n2 ? 0 : a2 / n2, k2 += a2 / n2, r = true) : (m2 = (Math.abs(ca3) * b2 - Math.sqrt(n2)) / 2, n2 = b2 - 2 * m2 / Math.abs(ca3), k2 += m2, k2 > g2 && (k2 -= m2, n2 = c2, r = (b2 + n2) * (g2 - k2) / 2, a2 -= r, m2 = g2 - k2, k2 += g2 - k2, m2 += a2 / n2, k2 += a2 / n2, r = true), b2 = n2)), e2.push(m2);
            return e2;
          }
          function b() {
            if (s && z) {
              for (var a2, b2, c2, g2, e2, h2, d3, r, k2, m2, n2, q2, l3, x, u2, w2 = [], t4 = [], J = { percent: null, total: null }, C2 = null, B2 = 0; B2 < z.length; B2++)
                u2 = R[B2], u2 = "undefined" !== typeof u2.x5 ? (u2.y2 + u2.y4) / 2 : (u2.y2 + u2.y3) / 2, u2 = f(u2).x2 + 1, w2[B2] = K2 - u2 - T;
              u2 = 0.5 * T;
              for (var B2 = 0, A4 = z.length - 1; B2 < z.length || 0 <= A4; B2++, A4--) {
                b2 = s.reversed ? z[A4] : z[B2];
                ...
                "inside" === s.indexLabelPlacement && (w2[B2] = B2 !== ea2 ? s.reversed ? R[B2].x2 - R[B2].x1 : R[B2].x3 - R[B2].x4 : R[B2].x3 - R[B2].x6, 20 > w2[B2] && (w2[B2] = B2 !== ea2 ? s.reversed ? R[B2].x3 - R[B2].x4 : R[B2].x2 - R[B2].x1 : R[B2].x2 - R[B2].x1, w2[B2] /= 2));
                ...
                if (s.indexLabelFormatter || b2.indexLabelFormatter)
                  C2 = { chart: y.options, dataSeries: s, dataPoint: b2, total: J.total, percent: J.percent };
                b2 = b2.indexLabelFormatter ? b2.indexLabelFormatter(C2) : b2.indexLabel ? y.replaceKeywordsWithValue(b2.indexLabel, b2, s, B2) : s.indexLabelFormatter ? s.indexLabelFormatter(C2) : s.indexLabel ? y.replaceKeywordsWithValue(s.indexLabel, b2, s, B2) : b2.label ? b2.label : "";
                0 >= m2 && (m2 = 0);
                ...
                U2.roundRect || za(U2);
                c2 = new ka(U2, { fontSize: h2, fontFamily: r, fontColor: e2, fontStyle: d3, fontWeight: k2, horizontalAlign: c2, textAlign: x, backgroundColor: g2, maxWidth: l3, maxHeight: false === t4[B2] ? q2 ? 4.28571429 * h2 : 1.5 * h2 : t4[B2], text: b2, padding: da2, textBaseline: "middle" });
                c2.measureText();
                c2.height = c2.height === 2 * c2.padding ? 0 : c2.height;
                c2.width = c2.width === 2 * c2.padding ? 0 : c2.width;
                G.push({ textBlock: c2, id: s.reversed ? A4 : B2, isDirty: false, lineColor: a2, lineThickness: m2, lineDashType: n2, height: c2.height < c2.maxHeight ? c2.height : c2.maxHeight, width: c2.width < c2.maxWidth ? c2.width : c2.maxWidth });
              }
            }
          }
          function e() {
            ...
            e2 = false;
            c2 = 0;
            for (var h2, d3 = K2 - Z2 - T / 2, d3 = s.options.indexLabelMaxWidth ? s.indexLabelMaxWidth > d3 ? d3 : s.indexLabelMaxWidth : d3, r = G.length - 1; 0 <= r; r--) {
              h2 = z[G[r].id];
              c2 = G[r];
              g2 = c2.textBlock;
              b2 = (a2 = n(r) < R.length ? G[n(r)] : null) ? a2.textBlock : null;
              c2 = c2.height;
              a2 && g2.y + c2 + da2 > b2.y && (e2 = true);
            ...
            if (e2)
              for (r = G.length - 1; 0 <= r; r--)
                a2 = R[r], G[r].textBlock.maxWidth = f2[f2.length - (r + 1)], G[r].textBlock.measureText(), G[r].textBlock.height = G[r].textBlock.height === 2 * G[r].textBlock.padding ? 0 : G[r].textBlock.height, G[r].textBlock.width = G[r].textBlock.width === 2 * G[r].textBlock.padding ? 0 : G[r].textBlock.width, G[r].textBlock.x = K2 - d3, c2 = G[r].textBlock.height < G[r].textBlock.maxHeight ? G[r].textBlock.height : G[r].textBlock.maxHeight, e2 = G[r].textBlock.width < G[r].textBlock.maxWidth ? G[r].textBlock.width : G[r].textBlock.maxWidth, G[r].height = c2, G[r].width = e2, c2 = "undefined" !== typeof a2.x5 ? (a2.y2 + a2.y4) / 2 : (a2.y2 + a2.y3) / 2, G[r].textBlock.y = c2 - G[r].height / 2, s.reversed ? (G[r].textBlock.y + G[r].height > V3 + E && (G[r].textBlock.y = V3 + E - G[r].height), G[r].textBlock.y < ua - E && (G[r].textBlock.y = ua - E)) : (G[r].textBlock.y < V3 - E && (G[r].textBlock.y = V3 - E), G[r].textBlock.y + G[r].height > ua + E && (G[r].textBlock.y = ua + E - G[r].height));
          }
          function h() {
            var a2, b2, c2, g2;
            if ("inside" !== s.indexLabelPlacement)
              for (var e2 = 0; e2 < R.length; e2++)
                0 == G[e2].textBlock.text.length ? G[e2].isDirty = true : (a2 = R[e2], c2 = "undefined" !== typeof a2.x5 ? (a2.y2 + a2.y4) / 2 : (a2.y2 + a2.y3) / 2, b2 = s.reversed ? "undefined" !== typeof a2.x5 ? c2 > $ ? f(c2).x2 + 1 : (a2.x2 + a2.x3) / 2 + 1 : (a2.x2 + a2.x3) / 2 + 1 : "undefined" !== typeof a2.x5 ? c2 < $ ? f(c2).x2 + 1 : (a2.x4 + a2.x3) / 2 + 1 : (a2.x2 + a2.x3) / 2 + 1, G[e2].textBlock.x = b2 + T, G[e2].textBlock.y = c2 - G[e2].height / 2, s.reversed ? (G[e2].textBlock.y + G[e2].height > V3 + E && (G[e2].textBlock.y = V3 + E - G[e2].height), G[e2].textBlock.y < ua - E && (G[e2].textBlock.y = ua - E)) : (G[e2].textBlock.y < V3 - E && (G[e2].textBlock.y = V3 - E), G[e2].textBlock.y + G[e2].height > ua + E && (G[e2].textBlock.y = ua + E - G[e2].height)));
            else
              for (e2 = 0; e2 < R.length; e2++)
                0 == G[e2].textBlock.text.length ? G[e2].isDirty = true : (a2 = R[e2], b2 = a2.height, c2 = G[e2].height, g2 = G[e2].width, b2 >= c2 ? (b2 = e2 != ea2 ? (a2.x4 + a2.x3) / 2 - g2 / 2 : (a2.x5 + a2.x4) / 2 - g2 / 2, c2 = e2 != ea2 ? (a2.y1 + a2.y3) / 2 - c2 / 2 : (a2.y1 + a2.y4) / 2 - c2 / 2, G[e2].textBlock.x = b2, G[e2].textBlock.y = c2) : G[e2].isDirty = true);
          }
          function d2() {
            function a2(b3, c3) {
              var e3;
            ...
            function b2() {
              ...
              for (var r2, k3 = 1; k3 < d3; k3++) {
                ...
                for (var p3 = G.length - 1; 0 <= p3; p3--)
                  !G[p3].isDirty && (G[p3].textBlock.y < g3 && G[p3].textBlock.y + G[p3].height > g3) && (r2 = n(p3), !(r2 >= G.length - 1) && G[p3].textBlock.y + G[p3].height + da2 > G[r2].textBlock.y && (G[p3].textBlock.y = G[p3].textBlock.y + G[p3].height - g3 > g3 - G[p3].textBlock.y ? g3 + 1 : g3 - G[p3].height - 1));
              }
              for (r2 = R.length - 1; 0 < r2; r2--)
                if (!G[r2].isDirty) {
                  ...
                  if (G[r2].textBlock.y < G[g3].textBlock.y + G[g3].height) {
                    e3 = e3 || r2;
                    f3 = r2;
                    for (d3 = 0; G[f3].textBlock.y < G[g3].textBlock.y + G[g3].height + da2; ) {
            ...
            function c2(a3, b3, e3) {
              ...
              for (e3 = 0; e3 < g3.length; e3++)
                if (b3 = g3[e3], f3 < a3)
                  h3++, f3 += G[b3.id].height + da2, G[b3.id].textBlock.text = "", G[b3.id].indexLabelText = "", G[b3.id].isDirty = true, G[b3.id].textBlock.measureText();
                else
                  break;
              return h3;
            }
            for (var e2, g2, f2, h2, r, k2, m2 = 1, p2 = 0; p2 < 2 * m2; p2++) {
              for (var s2 = G.length - 1; 0 <= s2 && !(0 <= q(s2) && q(s2), f2 = G[s2], h2 = f2.textBlock, k2 = (r = n(s2) < R.length ? G[n(s2)] : null) ? r.textBlock : null, e2 = +f2.height.toFixed(6), g2 = +h2.y.toFixed(6), !f2.isDirty && (r && g2 + e2 + da2 > +k2.y.toFixed(6)) && (e2 = h2.y + e2 + da2 - k2.y, g2 = a2(s2, -e2), g2 < e2 && (0 < g2 && (e2 -= g2), g2 = a2(n(s2), e2), g2 != e2))); s2--)
                ;
              b2();
            }
          }
          function l2(a2, b2) {
            return (b2 < R.length ? G[b2].textBlock.y : s.reversed ? V3 + E : ua + E) - (0 > a2 ? s.reversed ? ua - E : V3 - E : G[a2].textBlock.y + G[a2].height + da2);
          }
          function t3(a2, b2, c2) {
            var e2, g2, f2, d3 = [], r = E, n2 = [];
            -1 !== b2 && (0 <= W3.indexOf(b2) ? (g2 = W3.indexOf(b2), W3.splice(
              g2,
              1
            )) : (W3.push(b2), W3 = W3.sort(function(a3, b3) {
              return a3 - b3;
            })));
            if (0 === W3.length)
              d3 = ja3;
            else {
              g2 = E * (1 != W3.length || 0 != W3[0] && W3[0] != R.length - 1 ? 2 : 1) / k();
              for (var q2 = 0; q2 < R.length; q2++) {
                if (1 == W3.length && 0 == W3[0]) {
                  ...
                  0 === q2 && (e2 = -1 * r);
                d3.push(ja3[q2] + e2);
                if (0 <= W3.indexOf(q2) || q2 < R.length && 0 <= W3.indexOf(q2 + 1))
                  e2 += g2;
              }
            }
            f2 = function() {
            ...
            var p2 = { startTime: new Date().getTime(), duration: c2 || 500, easingFunction: function(a3, b3, c3, e3) {
              return N.easing.easeOutQuart(
                a3,
                b3,
                c3,
                e3
            ...
            a2._animator.animate(0, c2, function(c3) {
              ...
              for (g3 = 0; g3 < R.length; g3++)
                sa2(e3, R[g3], s.fillOpacity);
              w(e3);
              L && ("inside" !== s.indexLabelPlacement ? m(e3) : h(), A3(e3));
              1 <= c3 && (ia3 = false);
          ...
          var y = this;
          if (!(0 >= a.dataSeriesIndexes.length)) {
            for (var s = this.data[a.dataSeriesIndexes[0]], z = s.dataPoints, u = this.plotArea, E = 0.025 * u.width, C = 0.01 * u.width, B = 0, D2 = u.height - 2 * E, I2 = Math.min(u.width - 2 * C, 2.8 * u.height), L = false, Q = 0; Q < z.length; Q++)
            ...
            "inside" !== s.indexLabelPlacement && L || (C = (u.width - 0.75 * I2) / 2);
            var Q = u.x1 + C, K2 = u.x2 - C, P2 = u.y1 + E, S3 = u.y2 - E, U2 = a.targetCanvasCtx || this.plotArea.ctx || this.ctx;
            if (0 != s.length && (s.dataPoints && s.visible) && 0 !== z.length) {
              ...
              var C = Q + a / 2, X3 = Q, Z2 = Q + a, V3 = s.reversed ? S3 : P2, M = C - F / 2, ba = C + F / 2, $ = s.reversed ? P2 + O2 : S3 - O2, ua = s.reversed ? P2 : S3;
              a = [];
              var C = [], R = [], I2 = [], Y2 = P2, ea2, ca3 = ($ - V3) / (M - X3), ga3 = -ca3, Q = "area" === (s.valueRepresents ? s.valueRepresents : "height") ? c() : g();
              if (-1 !== Q) {
                if (s.reversed)
                  for (I2.push(Y2), F = Q.length - 1; 0 < F; F--)
                    Y2 += Q[F], I2.push(Y2);
                else
                ...
                if (s.reversed)
                  for (F = 0; F < Q.length; F++)
                    I2[F] < $ ? (a.push(M), C.push(ba), ea2 = F) : (a.push((I2[F] - V3 + ca3 * X3) / ca3), C.push((I2[F] - V3 + ga3 * Z2) / ga3));
                else
                  for (F = 0; F < Q.length; F++)
                    I2[F] < $ ? (a.push((I2[F] - V3 + ca3 * X3) / ca3), C.push((I2[F] - V3 + ga3 * Z2) / ga3), ea2 = F) : (a.push(M), C.push(ba));
                for (F = 0; F < Q.length - 1; F++)
                  Y2 = s.reversed ? z[z.length - 1 - F].color ? z[z.length - 1 - F].color : s._colorSet[(z.length - 1 - F) % s._colorSet.length] : z[F].color ? z[F].color : s._colorSet[F % s._colorSet.length], F === ea2 ? R.push({ x1: a[F], y1: I2[F], x2: C[F], y2: I2[F], x3: ba, y3: $, x4: C[F + 1], y4: I2[F + 1], x5: a[F + 1], y5: I2[F + 1], x6: M, y6: $, id: F, height: I2[F + 1] - I2[F], color: Y2 }) : R.push({
                    x1: a[F],
                    y1: I2[F],
                    x2: C[F],
                    y2: I2[F],
                ...
                var da2 = 2, G = [], ia3 = false, W3 = [], ja3 = [], Q = false;
                a = a = 0;
                Da(W3);
                for (F = 0; F < z.length; F++)
                  z[F].exploded && (Q = true, s.reversed ? W3.push(z.length - 1 - F) : W3.push(F));
                ...
                if (L && s.visible && (b(), h(), "inside" !== s.indexLabelPlacement)) {
                  ...
                  for (F = 0; F < R.length; F++)
                    R[F].x1 += B, R[F].x2 += B, R[F].x3 += B, R[F].x4 += B, R[F].x5 && (R[F].x5 += B, R[F].x6 += B), G[F].textBlock.x += B;
                }
                for (F = 0; F < R.length; F++)
                  B = R[F], sa2(U2, B, s.fillOpacity), ja3.push(B.y1);
                w(U2);
                L && s.visible && ("inside" === s.indexLabelPlacement || y.animationEnabled || m(U2), y.animationEnabled || A3());
                if (!L)
                  for (F = 0; F < z.length; F++)
                    B = s.dataPointIds[F], a = { id: B, objectType: "dataPoint", dataPointIndex: F, dataSeriesIndex: 0, funnelSection: R[s.reversed ? z.length - 1 - F : F] }, y._eventManager.objectMap[B] = a;
                !y.animationEnabled && Q ? t3(y, -1, 0) : y.animationEnabled && !y.animatedRender && t3(y, -1, 0);
                ...
                return { source: U2, dest: this.plotArea.ctx, animationCallback: function(a2, b2) {
                  ...
                  1 <= a2 && (t3(y, -1, 500), w(y.plotArea.ctx || y.ctx));
        ...
        l.prototype.replaceKeywordsWithValue = function(a, g, c, b, e) {
          ...
          if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            ...
            do {
              ...
              a = a.replace("#percent", da(d2, l2, h._cultureInfo));
              a = a.replace("#total", da(p2, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", h._cultureInfo));
        ...
        S2.prototype.setLayout = function() {
          ...
          for (var m = 0; m < this.dataSeries.length; m++) {
            ...
            if (q.dataPoints && q.dataPoints.length)
              if ("pie" !== q.type && "doughnut" !== q.type && "funnel" !== q.type && "pyramid" !== q.type) {
                var n = q.legendMarkerType = q.legendMarkerType ? q.legendMarkerType : "line" !== q.type && "stepLine" !== q.type && "spline" !== q.type && "scatter" !== q.type && "bubble" !== q.type || !q.markerType ? "error" === q.type && q._linkedSeries ? q._linkedSeries.legendMarkerType ? q._linkedSeries.legendMarkerType : X2.getDefaultLegendMarker(q._linkedSeries.type) : X2.getDefaultLegendMarker(q.type) : q.markerType, f = q.legendText ? q.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: q, dataPoint: null }) : q.name, t3 = q.legendMarkerColor = q.legendMarkerColor ? q.legendMarkerColor : q.markerColor ? q.markerColor : "error" === q.type ? p(q.whiskerColor) ? q._colorSet[0] : q.whiskerColor : q._colorSet[0], w = q.markerSize || "line" !== q.type && "stepLine" !== q.type && "spline" !== q.type ? 0.75 * this.lineHeight : 0, y = q.legendMarkerBorderColor ? q.legendMarkerBorderColor : q.markerBorderColor, s = q.legendMarkerBorderThickness ? q.legendMarkerBorderThickness : q.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0;
                "error" === q.type && this.errorMarkerColor.push(t3);
                f = this.chart.replaceKeywordsWithValue(f, q.dataPoints[0], q, m);
                n = { markerType: n, markerColor: t3, text: f, textBlock: null, chartType: q.type, markerSize: w, lineColor: q._colorSet[0], dataSeriesIndex: q.index, dataPointIndex: null, markerBorderColor: y, markerBorderThickness: s };
                v2.push(n);
              } else
                for (var z = 0; z < q.dataPoints.length; z++) {
                  var u = q.dataPoints[z], n = u.legendMarkerType ? u.legendMarkerType : q.legendMarkerType ? q.legendMarkerType : X2.getDefaultLegendMarker(q.type), f = u.legendText ? u.legendText : q.legendText ? q.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: q, dataPoint: u }) : u.name ? u.name : "DataPoint: " + (z + 1), t3 = u.legendMarkerColor ? u.legendMarkerColor : q.legendMarkerColor ? q.legendMarkerColor : u.color ? u.color : q.color ? q.color : q._colorSet[z % q._colorSet.length], w = 0.75 * this.lineHeight, y = u.legendMarkerBorderColor ? u.legendMarkerBorderColor : q.legendMarkerBorderColor ? q.legendMarkerBorderColor : u.markerBorderColor ? u.markerBorderColor : q.markerBorderColor, s = u.legendMarkerBorderThickness ? u.legendMarkerBorderThickness : q.legendMarkerBorderThickness ? q.legendMarkerBorderThickness : u.markerBorderThickness || q.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0, f = this.chart.replaceKeywordsWithValue(f, u, q, z), n = {
                    markerType: n,
                    markerColor: t3,
                    text: f,
                    textBlock: null,
          ...
          if (0 < v2.length) {
            ...
            u = (this.itemMaxWidth ? this.itemMaxWidth : u) - (w + l2);
            for (m = 0; m < v2.length; m++) {
              ...
              if (!(0 >= d2 || "undefined" === typeof d2 || 0 >= t3 || "undefined" === typeof t3))
                if ("horizontal" === this.orientation) {
                  n.textBlock = new ka(this.ctx, { x: 0, y: 0, maxWidth: t3, maxHeight: this.itemWrap ? d2 : this.lineHeight, angle: 0, text: n.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" });
                  n.textBlock.measureText();
                  null !== this.itemWidth && (n.textBlock.width = this.itemWidth - (w + l2 + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0)));
                  if (!q || q.width + Math.round(n.textBlock.width + w + l2 + (0 === q.width ? 0 : this.horizontalSpacing) + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0)) > h)
                  ...
                  n.textBlock.y = 0;
                  q.width += Math.round(n.textBlock.width + w + l2 + (0 === q.width ? 0 : this.horizontalSpacing) + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0));
                  q.items.push(n);
                  ...
                  n.textBlock = new ka(this.ctx, {
                    ...
                    fontStyle: this.fontStyle,
                    textBaseline: "middle"
                  }), n.textBlock.measureText(), null !== this.itemWidth && (n.textBlock.width = this.itemWidth - (w + l2 + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < d2 - this.lineHeight ? (q = { items: [], width: 0 }, k.push(q)) : (q = k[z], z = (z + 1) % k.length), q && (this.height += n.textBlock.height ? n.textBlock.height : this.lineHeight, n.textBlock.x = q.width, n.textBlock.y = 0, q.width += Math.round(n.textBlock.width + w + l2 + (0 === q.width ? 0 : this.horizontalSpacing) + ("line" === n.chartType || "spline" === n.chartType || "stepLine" === n.chartType ? 2 * 0.1 * this.lineHeight : 0)), q.items.push(n), this.width = Math.max(q.width, this.width));
            }
        ...
        S2.prototype.render = function() {
          ...
          for (var p2 = 0, l2 = 0; l2 < d2.length; l2++) {
            for (var k = d2[l2], m = 0, q = 0; q < k.items.length; q++) {
              var n = k.items[q], f = n.textBlock.x + a + (0 === q ? 0.2 * h : this.horizontalSpacing), v2 = g + p2, w = f;
              ...
              if ("line" === n.chartType || "stepLine" === n.chartType || "spline" === n.chartType)
                this.ctx.strokeStyle = n.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(f - 0.1 * this.lineHeight, v2 + this.lineHeight / 2), this.ctx.lineTo(f + 0.85 * this.lineHeight, v2 + this.lineHeight / 2), this.ctx.stroke(), w -= 0.1 * this.lineHeight;
              if ("error" === n.chartType) {
                this.ctx.strokeStyle = this.errorMarkerColor[0];
                this.ctx.lineWidth = h / 8;
                this.ctx.beginPath();
                var y = f - 0.08 * this.lineHeight + 0.1 * this.lineHeight, s = v2 + 0.15 * this.lineHeight, z = 0.7 * this.lineHeight, u = z + 0.02 * this.lineHeight;
                this.ctx.moveTo(y, s);
              ...
              Y.drawMarker(f + h / 2, v2 + this.lineHeight / 2, this.ctx, n.markerType, "error" === n.chartType || "line" === n.chartType || "spline" === n.chartType ? n.markerSize / 2 : n.markerSize, n.markerColor, n.markerBorderColor, n.markerBorderThickness);
              n.textBlock.x = f + c + h;
              if ("line" === n.chartType || "stepLine" === n.chartType || "spline" === n.chartType)
        ...
        pa(X2, Z);
        X2.prototype.getDefaultAxisPlacement = function() {
          var a = this.type;
        ...
        X2.getDefaultLegendMarker = function(a) {
        ...
        X2.prototype.getDataPointAtX = function(a, g) {
        ...
        X2.prototype.getDataPointAtXY = function(a, g, c) {
            ...
            if (0 <= h && h < this.dataPoints.length) {
              ...
              if (n) {
                switch (this.type) {
                  ...
                  case "splineArea":
                  case "scatter":
                    var w = na("markerSize", f, this) || 4, y = c ? 20 : w, t3 = Math.sqrt(Math.pow(n.x1 - a, 2) + Math.pow(n.y1 - g, 2));
                  ...
                  case "bubble":
                    ...
                    t3 <= w / 2 && (b.push({ dataPoint: f, dataPointIndex: h, dataSeries: this, distance: t3 }), l2 = true);
                    break;
                  case "pie":
                  case "doughnut":
                    w = n.center;
                    ...
                    t3 < n.radius && t3 > y && (t3 = Math.atan2(g - w.y, a - w.x), 0 > t3 && (t3 += 2 * Math.PI), t3 = Number(((180 * (t3 / Math.PI) % 360 + 360) % 360).toFixed(12)), w = Number(((180 * (n.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), y = Number(((180 * (n.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === y && 1 < n.endAngle && (y = 360), w >= y && (0 !== f.y && !p(f.y)) && (y += 360, t3 < w && (t3 += 360)), t3 > w && t3 < y && (b.push({ dataPoint: f, dataPointIndex: h, dataSeries: this, distance: 0 }), l2 = true));
                    break;
                  case "funnel":
                  case "pyramid":
                    t3 = n.funnelSection;
        ...
        X2.prototype.getMarkerProperties = function(a, g, c, b) {
        ...
        D.prototype.createLabels = function() {
          ...
          if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
            ...
            if (this.logarithmic && !this.equidistantInterval)
              for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, f = n; b < this.logLabelValues.length; b++)
                if (c = this.logLabelValues[b], c < this.viewportMinimum)
                  ...
                  m = c;
                  a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: m, label: this.labels[m] ? this.labels[m] : null }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : da(m, this.valueFormatString, this.chart._cultureInfo), a = new ka(this.ctx, {
                    x: 0,
                    y: 0,
                    maxWidth: h,
                    maxHeight: d2,
            ...
            for (this.intervalStartPosition = this.getLabelStartPoint(
              ...
              this.intervalType,
              this.interval
            ), e = Ya(new Date(this.viewportMaximum), this.interval, this.intervalType), f = n, c = this.intervalStartPosition; c < e; Ya(c, b, this.intervalType)) {
          ...
          if ("bottom" === this._position || "top" === this._position)
            l2 = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * I[this.intervalType + "Duration"] * this.interval, h = "undefined" === typeof this.options.labelMaxWidth ? 0.5 * this.chart.width >> 0 : this.options.labelMaxWidth, this.chart.panEnabled || (d2 = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize);
                ...
                for (c = 0; c < this._labels.length; c++)
                  if (!this._labels[c].breaksLabelType) {
                    ...
                    for (var w, f = a.text.split(" "), b = 0; b < f.length; b++)
                      m = f[b], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, m = this.ctx.measureText(m), m.width > n && (w = c, n = m.width);
                  }
                c = 0;
        ...
        D.setLayout = function(a, g, c, b, e, h) {
          ...
          for (f = 0; f < n.length; f++)
            if (n[f] && n[f].scaleBreaks && n[f].scaleBreaks._appliedBreaks.length)
              for (var v2 = n[f].scaleBreaks._appliedBreaks, w = 0; w < v2.length && !(v2[w].startValue > n[f].viewportMaximum); w++)
                v2[w].endValue < n[f].viewportMinimum || (p(n[f].scaleBreaks.firstBreakIndex) && (n[f].scaleBreaks.firstBreakIndex = w), v2[w].startValue >= n[f].viewPortMinimum && (n[f].scaleBreaks.lastBreakIndex = w));
          for (var y = w = 0, s = 0, z = 0, u = 0, A3 = 0, C = 0, B, D2, H2 = l2 = 0, I2, Q, K2, v2 = I2 = Q = K2 = false, f = 0; f < n.length; f++)
          ...
          if ("normal" === e) {
            for (var z = [], u = [], A3 = [], C = [], N2 = [], P2 = [], O2 = [], S3 = []; 4 > w; ) {
              var F = 0, U2 = 0, T = 0, V3 = 0, X3 = e = 0, M = 0, Z2 = 0, W3 = 0, Y2 = 0, R = 0, $ = 0;
              if (c && 0 < c.length)
                for (A3 = [], f = R = 0; f < c.length; f++)
                  A3.push(Math.ceil(c[f] ? c[f].createLabelsAndCalculateWidth() : 0)), R += A3[f], M += c[f] && !m.isNavigator ? c[f].margin : 0;
              else
                A3.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
              O2.push(A3);
              if (b && 0 < b.length)
                for (C = [], f = $ = 0; f < b.length; f++)
                  C.push(Math.ceil(b[f] ? b[f].createLabelsAndCalculateWidth() : 0)), $ += C[f], Z2 += b[f] ? b[f].margin : 0;
              else
              ...
              if (a && 0 < a.length)
                for (z = [], f = W3 = 0; f < a.length; f++)
                  a[f] && (a[f].lineCoordinates = {}), a[f].lineCoordinates.width = Math.abs(t3 - d2), a[f].title && (a[f]._titleTextBlock.maxWidth = 0 < a[f].titleMaxWidth && a[f].titleMaxWidth < a[f].lineCoordinates.width ? a[f].titleMaxWidth : a[f].lineCoordinates.width), z.push(Math.ceil(a[f] ? a[f].createLabelsAndCalculateHeight() : 0)), W3 += z[f], e += a[f] && !m.isNavigator ? a[f].margin : 0;
              else
                z.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
              N2.push(z);
              if (g && 0 < g.length)
                for (u = [], f = Y2 = 0; f < g.length; f++)
                  g[f] && (g[f].lineCoordinates = {}), g[f].lineCoordinates.width = Math.abs(t3 - d2), g[f].title && (g[f]._titleTextBlock.maxWidth = 0 < g[f].titleMaxWidth && g[f].titleMaxWidth < g[f].lineCoordinates.width ? g[f].titleMaxWidth : g[f].lineCoordinates.width), u.push(Math.ceil(g[f] ? g[f].createLabelsAndCalculateHeight() : 0)), Y2 += u[f], X3 += g[f] && !m.isNavigator ? g[f].margin : 0;
              else
                u.push(Math.ceil(g[0] ? g[0].createLabelsAndCalculateHeight() : 0));
              P2.push(u);
              if (a && 0 < a.length)
                for (f = 0; f < a.length; f++)
                  a[f] && (a[f].lineCoordinates.x1 = d2, t3 = Math.round(h.x2 - $ - Z2 > m.width - q ? m.width - q : h.x2 - $ - Z2), a[f]._labels && 1 < a[f]._labels.length && (l2 = k = 0, k = a[f]._labels[1], l2 = "dateTime" === a[f].valueType ? a[f]._labels[a[f]._labels.length - 2] : a[f]._labels[a[f]._labels.length - 1], y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - l2.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), s = l2.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l2.textBlock.angle)) + (l2.textBlock.height - l2.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l2.textBlock.angle))), !a[f] || (!a[f].labelAutoFit || p(B) || p(D2) || m.isNavigator || m.stockChart) || (l2 = 0, 0 < a[f].labelAngle ? D2 + s > t3 && (l2 += 0 < a[f].labelAngle ? D2 + s - t3 - $ : 0) : 0 > a[f].labelAngle ? B - y < d2 && B - y < a[f].viewportMinimum && (H2 = d2 - (M + a[f].tickLength + A3 + B - y + a[f].labelFontSize / 2)) : 0 === a[f].labelAngle && (D2 + s > t3 && (l2 = D2 + s / 2 - t3 - $), B - y < d2 && B - y < a[f].viewportMinimum && (H2 = d2 - M - a[f].tickLength - A3 - B + y / 2)), a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 < a[f].labelAngle && 0 < l2 ? t3 -= l2 : a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 > a[f].labelAngle && 0 < H2 ? d2 += H2 : a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 === a[f].labelAngle && (0 < H2 && (d2 += H2), 0 < l2 && (t3 -= l2))), m.panEnabled ? W3 = p(m.sessionVariables.axisX.height) ? m.sessionVariables.axisX.height = W3 : m.sessionVariables.axisX.height : m.sessionVariables.axisX.height = W3, l2 = Math.round(h.y2 - W3 - e + F), k = Math.round(h.y2), a[f].lineCoordinates.x2 = t3, a[f].lineCoordinates.width = t3 - d2, a[f].lineCoordinates.y1 = l2, a[f].lineCoordinates.y2 = l2, "inside" === a[f].labelPlacement && 0 < f && (a[f].lineCoordinates.y1 = a[f - 1].lineCoordinates.y2 + F + (a[f].labelEffectiveHeight || 0), a[f].lineCoordinates.y2 = a[f].lineCoordinates.y1 + a[f].lineThickness / 2), "inside" === a[f].tickPlacement && 0 < f && (a[f].lineCoordinates.y1 += a[f].tickLength, a[f].lineCoordinates.y2 = a[f].lineCoordinates.y1 + a[f].lineThickness / 2), a[f].bounds = { x1: d2, y1: l2, x2: t3, y2: k - (W3 + e - z[f] - F), width: t3 - d2 }, a[f].bounds.height = a[f].bounds.y2 - a[f].bounds.y1), F += z[f] + a[f].margin;
              if (g && 0 < g.length)
                for (f = 0; f < g.length; f++)
                  g[f].lineCoordinates.x1 = Math.round(h.x1 + R + M), g[f].lineCoordinates.x2 = Math.round(h.x2 - $ - Z2 > m.width - q ? m.width - q : h.x2 - $ - Z2), g[f].lineCoordinates.width = Math.abs(t3 - d2), g[f]._labels && 1 < g[f]._labels.length && (k = g[f]._labels[1], l2 = "dateTime" === g[f].valueType ? g[f]._labels[g[f]._labels.length - 2] : g[f]._labels[g[f]._labels.length - 1], y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - l2.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), s = l2.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l2.textBlock.angle)) + (l2.textBlock.height - l2.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l2.textBlock.angle))), m.panEnabled ? Y2 = p(m.sessionVariables.axisX2.height) ? m.sessionVariables.axisX2.height = Y2 : m.sessionVariables.axisX2.height : m.sessionVariables.axisX2.height = Y2, l2 = Math.round(h.y1), k = g[f].lineCoordinates.y1 = l2 + Y2 + X3 - U2, g[f].lineCoordinates.y2 = l2, "inside" === g[f].labelPlacement && 0 < f && (g[f].lineCoordinates.y1 = g[f - 1].lineCoordinates.y1 - U2 - (g[f].labelEffectiveHeight || 0)), "inside" === g[f].tickPlacement && 0 < f && (g[f].lineCoordinates.y1 -= g[f].tickLength), g[f].bounds = {
                    x1: d2,
                    y1: l2 + (Y2 + X3 - u[f] - U2),
                    x2: t3,
                    y2: k,
                    width: t3 - d2
                  }, g[f].bounds.height = g[f].bounds.y2 - g[f].bounds.y1, U2 += u[f] + g[f].margin;
              if (c && 0 < c.length)
                for (f = 0; f < c.length; f++)
                  M = m.isNavigator ? 0 : 10, c[f] && (d2 = Math.round(a[0] ? a[0].lineCoordinates.x1 : g[0].lineCoordinates.x1), M = c[f]._labels && 0 < c[f]._labels.length ? c[f]._labels[c[f]._labels.length - 1].textBlock.height / 2 : q, l2 = Math.round(h.y1 + Y2 + X3 < Math.max(M, q) ? Math.max(M, q) : h.y1 + Y2 + X3), t3 = Math.round(a[0] ? a[0].lineCoordinates.x1 : g[0].lineCoordinates.x1), M = 0 < a.length ? 0 : c[f]._labels && 0 < c[f]._labels.length ? c[f]._labels[0].textBlock.height / 2 : q, k = Math.round(h.y2 - W3 - e - M), c[f].lineCoordinates = { x1: d2 - T, y1: l2, x2: t3 - T, y2: k, height: Math.abs(k - l2) }, "inside" === c[f].labelPlacement && 0 < f && (c[f].lineCoordinates.x1 = c[f - 1].lineCoordinates.x1 - T - (c[f].labelEffectiveWidth || 0), c[f].lineCoordinates.x2 = c[f].lineCoordinates.x1 + c[f].lineThickness / 2), "inside" === c[f].tickPlacement && 0 < f && (c[f].lineCoordinates.x1 -= c[f].tickLength, c[f].lineCoordinates.x2 = c[f].lineCoordinates.x1 + c[f].lineThickness / 2), c[f].bounds = { x1: d2 - (A3[f] + T), y1: l2, x2: t3 - T, y2: k, height: k - l2 }, c[f].bounds.width = c[f].bounds.x2 - c[f].bounds.x1, c[f].title && (c[f]._titleTextBlock.maxWidth = 0 < c[f].titleMaxWidth && c[f].titleMaxWidth < c[f].lineCoordinates.height ? c[f].titleMaxWidth : c[f].lineCoordinates.height), T += A3[f] + c[f].margin);
              if (b && 0 < b.length)
                for (f = 0; f < b.length; f++)
                  b[f] && (d2 = Math.round(a[0] ? a[0].lineCoordinates.x2 : g[0].lineCoordinates.x2), t3 = Math.round(d2), M = b[f]._labels && 0 < b[f]._labels.length ? b[f]._labels[b[f]._labels.length - 1].textBlock.height / 2 : 0, l2 = Math.round(h.y1 + Y2 + X3 < Math.max(
                    M,
                    q
                  ) ? Math.max(M, q) : h.y1 + Y2 + X3), M = 0 < a.length ? 0 : b[f]._labels && 0 < b[f]._labels.length ? b[f]._labels[0].textBlock.height / 2 : 0, k = Math.round(h.y2 - (W3 + e + M)), b[f].lineCoordinates = { x1: d2 + V3, y1: l2, x2: d2 + V3, y2: k, height: Math.abs(k - l2) }, "inside" === b[f].labelPlacement && 0 < f && (b[f].lineCoordinates.x1 = b[f - 1].lineCoordinates.x2 + V3 + (b[f].labelEffectiveWidth || 0), b[f].lineCoordinates.x2 = b[f].lineCoordinates.x1 + b[f].lineThickness / 2), "inside" === b[f].tickPlacement && 0 < f && (b[f].lineCoordinates.x1 += b[f].tickLength, b[f].lineCoordinates.x2 = b[f].lineCoordinates.x1 + b[f].lineThickness / 2), b[f].bounds = { x1: d2 + V3, y1: l2, x2: t3 + (C[f] + V3), y2: k, height: k - l2 }, b[f].bounds.width = b[f].bounds.x2 - b[f].bounds.x1, b[f].title && (b[f]._titleTextBlock.maxWidth = 0 < b[f].titleMaxWidth && b[f].titleMaxWidth < b[f].lineCoordinates.height ? b[f].titleMaxWidth : b[f].lineCoordinates.height), V3 += C[f] + b[f].margin);
              if (a && 0 < a.length)
                for (f = 0; f < a.length; f++)
              ...
              if (0 < w) {
                ...
                if (g && 0 < g.length)
                  for (f = 0; f < g.length; f++)
                    I2 = P2[w - 1][f] === P2[w][f] ? true : false;
                else
                  I2 = true;
                if (c && 0 < c.length)
                  for (f = 0; f < c.length; f++)
                    Q = O2[w - 1][f] === O2[w][f] ? true : false;
                else
                  Q = true;
                if (b && 0 < b.length)
                  for (f = 0; f < b.length; f++)
                    K2 = S3[w - 1][f] === S3[w][f] ? true : false;
                else
                  K2 = true;
              }
              if (v2 && I2 && Q && K2)
            ...
            N2 = [];
            for (P2 = []; 4 > w; ) {
              W3 = V3 = T = Z2 = M = X3 = e = S3 = O2 = F = Y2 = 0;
              if (a && 0 < a.length)
                for (H2 = [], f = V3 = 0; f < a.length; f++)
                  H2.push(Math.ceil(a[f] ? a[f].createLabelsAndCalculateWidth() : 0)), V3 += H2[f], e += a[f] && !m.isNavigator ? a[f].margin : 0;
              else
                H2.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
              N2.push(H2);
              if (g && 0 < g.length)
                for (y = [], f = W3 = 0; f < g.length; f++)
                  y.push(Math.ceil(g[f] ? g[f].createLabelsAndCalculateWidth() : 0)), W3 += y[f], X3 += g[f] ? g[f].margin : 0;
              else
                y.push(Math.ceil(g[0] ? g[0].createLabelsAndCalculateWidth() : 0));
              P2.push(y);
              if (c && 0 < c.length)
                for (f = 0; f < c.length; f++)
                  c[f].lineCoordinates = {}, d2 = Math.round(h.x1 + V3 + e), t3 = Math.round(h.x2 - W3 - X3 > m.width - 10 ? m.width - 10 : h.x2 - W3 - X3), c[f].labelAutoFit && !p(z) && (0 < !a.length && (d2 = 0 > c[f].labelAngle ? Math.max(d2, z) : 0 === c[f].labelAngle ? Math.max(d2, z / 2) : d2), 0 < !g.length && (t3 = 0 < c[f].labelAngle ? t3 - u / 2 : 0 === c[f].labelAngle ? t3 - u / 2 : t3)), c[f].lineCoordinates.x1 = d2, c[f].lineCoordinates.x2 = t3, c[f].lineCoordinates.width = Math.abs(t3 - d2), c[f].title && (c[f]._titleTextBlock.maxWidth = 0 < c[f].titleMaxWidth && c[f].titleMaxWidth < c[f].lineCoordinates.width ? c[f].titleMaxWidth : c[f].lineCoordinates.width);
              if (b && 0 < b.length)
                for (f = 0; f < b.length; f++)
                  b[f].lineCoordinates = {}, d2 = Math.round(h.x1 + V3 + e), t3 = Math.round(h.x2 - W3 - X3 > b[f].chart.width - 10 ? b[f].chart.width - 10 : h.x2 - W3 - X3), b[f] && b[f].labelAutoFit && !p(A3) && (0 < !a.length && (d2 = 0 < b[f].labelAngle ? Math.max(d2, A3) : 0 === b[f].labelAngle ? Math.max(d2, A3 / 2) : d2), 0 < !g.length && (t3 -= C / 2)), b[f].lineCoordinates.x1 = d2, b[f].lineCoordinates.x2 = t3, b[f].lineCoordinates.width = Math.abs(t3 - d2), b[f].title && (b[f]._titleTextBlock.maxWidth = 0 < b[f].titleMaxWidth && b[f].titleMaxWidth < b[f].lineCoordinates.width ? b[f].titleMaxWidth : b[f].lineCoordinates.width);
              if (c && 0 < c.length)
                for (q = [], f = T = 0; f < c.length; f++)
                  q.push(Math.ceil(c[f] ? c[f].createLabelsAndCalculateHeight() : 0)), T += q[f] + c[f].margin, M += c[f].margin;
              else
                q.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
              D2.push(q);
              if (b && 0 < b.length)
                for (B = [], f = 0; f < b.length; f++)
                  B.push(Math.ceil(b[f] ? b[f].createLabelsAndCalculateHeight() : 0)), Z2 += b[f].margin;
              else
              ...
              if (c && 0 < c.length)
                for (f = c.length - 1; 0 <= f; f--)
                  l2 = Math.round(h.y2), k = Math.round(h.y2 > c[f].chart.height ? c[f].chart.height : h.y2), c[f].lineCoordinates.y1 = l2 - (q[f] + c[f].margin + Y2), c[f].lineCoordinates.y2 = l2 - (q[f] + c[f].margin + Y2), "inside" === c[f].labelPlacement && 0 < f && (c[f].lineCoordinates.y1 = c[f].lineCoordinates.y1 + q[f] - (c[f]._titleTextBlock ? c[f]._titleTextBlock.height : 0) - c[f].tickLength - (c[f].stripLineLabelEffectiveHeight || 0) - 5, c[f].lineCoordinates.y2 = c[f].lineCoordinates.y1 + c[f].lineThickness / 2), "inside" === c[f].tickPlacement && 0 < f && (c[f].lineCoordinates.y1 += c[f].tickLength, c[f].lineCoordinates.y2 = c[f].lineCoordinates.y1 + c[f].lineThickness / 2), c[f].bounds = { x1: d2, y1: l2 - (q[f] + Y2 + c[f].margin), x2: t3, y2: k - (Y2 + c[f].margin), width: t3 - d2, height: q[f] }, c[f].title && (c[f]._titleTextBlock.maxWidth = 0 < c[f].titleMaxWidth && c[f].titleMaxWidth < c[f].lineCoordinates.width ? c[f].titleMaxWidth : c[f].lineCoordinates.width), Y2 += q[f] + c[f].margin;
              if (b && 0 < b.length)
                for (f = b.length - 1; 0 <= f; f--)
                  b[f] && (l2 = Math.round(h.y1), k = Math.round(h.y1 + (B[f] + b[f].margin + F)), b[f].lineCoordinates.y1 = k, b[f].lineCoordinates.y2 = k, "inside" === b[f].labelPlacement && 0 < f && (b[f].lineCoordinates.y1 = k - B[f] + (b[f]._titleTextBlock ? b[f]._titleTextBlock.height : 0) + b[f].tickLength + (b[f].stripLineLabelEffectiveHeight || 0), b[f].lineCoordinates.y2 = b[f].lineCoordinates.y1 - b[f].lineThickness / 2), "inside" === b[f].tickPlacement && 0 < f && (b[f].lineCoordinates.y1 -= b[f].tickLength, b[f].lineCoordinates.y2 = b[f].lineCoordinates.y1 - b[f].lineThickness / 2), b[f].bounds = { x1: d2, y1: l2 + (b[f].margin + F), x2: t3, y2: k, width: t3 - d2 }, b[f].bounds.height = b[f].bounds.y2 - b[f].bounds.y1, b[f].title && (b[f]._titleTextBlock.maxWidth = 0 < b[f].titleMaxWidth && b[f].titleMaxWidth < b[f].lineCoordinates.width ? b[f].titleMaxWidth : b[f].lineCoordinates.width), F += B[f] + b[f].margin);
              if (a && 0 < a.length)
                for (f = 0; f < a.length; f++) {
                  ...
                  k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : h.y2 - T > m.height - Math.max(M, 10) ? m.height - Math.max(M, 10) : h.y2 - T) : h.y2 > m.height - Math.max(
                    M,
                    10
                  ) ? m.height - Math.max(M, 10) : h.y2;
                  if (c && 0 < c.length)
                    for (M = 0; M < c.length; M++)
                      c[M] && c[M].labelAutoFit && (t3 = c[M].lineCoordinates.x1, d2 = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? t3 - V3 : d2);
                  if (b && 0 < b.length)
                    for (M = 0; M < b.length; M++)
                      b[M] && b[M].labelAutoFit && (t3 = b[M].lineCoordinates.x1, d2 = t3 - V3);
              ...
              if (g && 0 < g.length)
                for (f = 0; f < g.length; f++) {
                  ...
                  d2 = Math.round(h.x1 - e);
                  l2 = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : h.y1 < Math.max(M, 10) ? Math.max(M, 10) : h.y1) : h.y1 < Math.max(M, 10) ? Math.max(M, 10) : h.y1;
                  t3 = Math.round(h.x2 - W3 - X3);
                  k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : h.y2 - T > m.height - Math.max(M, 10) ? m.height - Math.max(
                    M,
                    10
                  ) : h.y2 - T) : h.y2 > m.height - Math.max(M, 10) ? m.height - Math.max(M, 10) : h.y2;
                  if (c && 0 < c.length)
                    for (M = 0; M < c.length; M++)
                      c[M] && c[M].labelAutoFit && (t3 = 0 > c[M].labelAngle ? Math.max(t3, z) : 0 === c[M].labelAngle ? Math.max(t3, z / 2) : t3, d2 = 0 > c[M].labelAngle || 0 === c[M].labelAngle ? t3 - W3 : d2);
                  if (b && 0 < b.length)
                    for (M = 0; M < b.length; M++)
                      b[M] && b[M].labelAutoFit && (t3 = b[M].lineCoordinates.x2, d2 = t3 - W3);
                  g[f].lineCoordinates = { x1: t3 + S3, y1: l2, x2: t3 + S3, y2: k, height: Math.abs(k - l2) };
                  ...
                  g[f].bounds = { x1: g[f].lineCoordinates.x1, y1: l2, x2: t3 + y[f] + S3, y2: k, width: t3 - d2, height: k - l2 };
              ...
              if (0 < w) {
                ...
                if (c && 0 < c.length)
                  for (f = 0; f < c.length; f++)
                    Q = D2[w - 1][f] === D2[w][f] ? true : false;
                else
                  Q = true;
                if (b && 0 < b.length)
                  for (f = 0; f < b.length; f++)
                    K2 = s[w - 1][f] === s[w][f] ? true : false;
                else
                  K2 = true;
              }
              if (v2 && I2 && Q && K2)
        ...
        D.prototype.calculateBreaksSizeInValues = function() {
          for (var a = "left" === this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width, g = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ? this.conversionParameters.maximum / this.conversionParameters.minimum : this.conversionParameters.maximum - this.conversionParameters.minimum), b = this.scaleBreaks && !p(this.scaleBreaks.options.spacing), e, h = 0; h < g.length; h++)
            e = b || !p(g[h].options.spacing), g[h].spacing = Ua(g[h].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0, g[h].size = 0 > g[h].spacing ? 0 : Math.abs(g[h].spacing / c), this.logarithmic && (g[h].size = Math.pow(this.logarithmBase, g[h].size));
        };
        ...
        D.prototype.calculateAxisParameters = function() {
          if (this.logarithmic)
            ...
            if ("axisX" === this.type && c) {
              ...
              this.intervalType || (b / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : b / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : b / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : b / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") : b / 20 <= a ? (this.interval = 20, this.intervalType = "millisecond") : b / 50 <= a ? (this.interval = 50, this.intervalType = "millisecond") : b / 100 <= a ? (this.interval = 100, this.intervalType = "millisecond") : b / 200 <= a ? (this.interval = 200, this.intervalType = "millisecond") : b / 250 <= a ? (this.interval = 250, this.intervalType = "millisecond") : b / 300 <= a ? (this.interval = 300, this.intervalType = "millisecond") : b / 400 <= a ? (this.interval = 400, this.intervalType = "millisecond") : b / 500 <= a ? (this.interval = 500, this.intervalType = "millisecond") : b / (1 * I.secondDuration) <= a ? (this.interval = 1, this.intervalType = "second") : b / (2 * I.secondDuration) <= a ? (this.interval = 2, this.intervalType = "second") : b / (5 * I.secondDuration) <= a ? (this.interval = 5, this.intervalType = "second") : b / (10 * I.secondDuration) <= a ? (this.interval = 10, this.intervalType = "second") : b / (15 * I.secondDuration) <= a ? (this.interval = 15, this.intervalType = "second") : b / (20 * I.secondDuration) <= a ? (this.interval = 20, this.intervalType = "second") : b / (30 * I.secondDuration) <= a ? (this.interval = 30, this.intervalType = "second") : b / (1 * I.minuteDuration) <= a ? (this.interval = 1, this.intervalType = "minute") : b / (2 * I.minuteDuration) <= a ? (this.interval = 2, this.intervalType = "minute") : b / (5 * I.minuteDuration) <= a ? (this.interval = 5, this.intervalType = "minute") : b / (10 * I.minuteDuration) <= a ? (this.interval = 10, this.intervalType = "minute") : b / (15 * I.minuteDuration) <= a ? (this.interval = 15, this.intervalType = "minute") : b / (20 * I.minuteDuration) <= a ? (this.interval = 20, this.intervalType = "minute") : b / (30 * I.minuteDuration) <= a ? (this.interval = 30, this.intervalType = "minute") : b / (1 * I.hourDuration) <= a ? (this.interval = 1, this.intervalType = "hour") : b / (2 * I.hourDuration) <= a ? (this.interval = 2, this.intervalType = "hour") : b / (3 * I.hourDuration) <= a ? (this.interval = 3, this.intervalType = "hour") : b / (6 * I.hourDuration) <= a ? (this.interval = 6, this.intervalType = "hour") : b / (1 * I.dayDuration) <= a ? (this.interval = 1, this.intervalType = "day") : b / (2 * I.dayDuration) <= a ? (this.interval = 2, this.intervalType = "day") : b / (4 * I.dayDuration) <= a ? (this.interval = 4, this.intervalType = "day") : b / (1 * I.weekDuration) <= a ? (this.interval = 1, this.intervalType = "week") : b / (2 * I.weekDuration) <= a ? (this.interval = 2, this.intervalType = "week") : b / (3 * I.weekDuration) <= a ? (this.interval = 3, this.intervalType = "week") : b / (1 * I.monthDuration) <= a ? (this.interval = 1, this.intervalType = "month") : b / (2 * I.monthDuration) <= a ? (this.interval = 2, this.intervalType = "month") : b / (3 * I.monthDuration) <= a ? (this.interval = 3, this.intervalType = "month") : b / (6 * I.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = b / (1 * I.yearDuration) <= a ? 1 : b / (2 * I.yearDuration) <= a ? 2 : b / (4 * I.yearDuration) <= a ? 4 : Math.floor(D.getNiceNumber(b / (a - 1), true) / I.yearDuration), this.intervalType = "year"));
        ...
        ca2.prototype.render = function(a, g, c) {
          ...
          if (this.snapToDataPoint) {
            ...
            if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
              ...
              if ("bottom" === this.parent._position || "top" === this.parent._position) {
                if ("rangeBar" === u.dataSeries.type || "error" === u.dataSeries.type) {
                  ...
                  k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: u.dataPoint.y[s] }) : p(this.options.label) ? da(p(c) ? u.dataPoint.y[s] : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
                } else
                  "stackedBar" === u.dataSeries.type ? (w = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), cumulativeY = u.dataSeries.dataPointEOs[u.index].cumulativeY, t3 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(cumulativeY) << 0) + 0.5 : this.parent.convertValueToPixel(cumulativeY) << 0, this.value = cumulativeY, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: cumulativeY }) : p(this.options.label) ? da(p(c) ? cumulativeY : c, this.valueFormatString, this.chart._cultureInfo) : this.label) : "stackedBar100" === u.dataSeries.type ? (w = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), cumulativeY = u.dataSeries.dataPointEOs[u.index].cumulativeY, z = u.dataPoint.x.getTime ? u.dataPoint.x.getTime() : u.dataPoint.x, yPercent = 100 * (cumulativeY / u.dataSeries.plotUnit.dataPointYSums[z]), t3 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(yPercent) << 0) + 0.5 : this.parent.convertValueToPixel(yPercent) << 0, this.value = yPercent, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: yPercent }) : p(this.options.label) ? da(
                    p(c) ? yPercent : c,
                    this.valueFormatString,
                    this.chart._cultureInfo
                  ) : this.label) : (t3 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(u.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(u.dataPoint.y) << 0, this.value = u.dataPoint.y, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: u.dataPoint.y }) : p(this.options.label) ? da(p(c) ? u.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label);
                b = e = t3;
                ...
                if (s) {
                  ...
                  k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ? this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: u.dataPoint.x }) : p(this.options.label) ? da(u.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: u.dataPoint.x }) : p(this.options.label) ? Ca(u.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label;
              ...
              for (s = 0; s < m.length; s++) {
                if ("rangeColumn" === m[s].dataSeries.type || "rangeArea" === m[s].dataSeries.type || "error" === m[s].dataSeries.type || "rangeSplineArea" === m[s].dataSeries.type || "candlestick" === m[s].dataSeries.type || "ohlc" === m[s].dataSeries.type || "boxAndWhisker" === m[s].dataSeries.type) {
                  ...
                  "stackedColumn" === m[s].dataSeries.type ? (b = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY, z = Math.abs(g - this.parent.convertValueToPixel(b)), z <= w && (w = z, y = s)) : "stackedArea" === m[s].dataSeries.type ? (b = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY, z = Math.abs(g - this.parent.convertValueToPixel(b)), z <= w && (w = z, y = s)) : "stackedColumn100" === m[s].dataSeries.type || "stackedArea100" === m[s].dataSeries.type ? (z = m[0].dataPoint.x.getTime ? m[0].dataPoint.x.getTime() : m[0].dataPoint.x, p(u) && (u = Math.abs(g - this.parent.convertValueToPixel(100 * (m[0].dataSeries.dataPointEOs[m[0].index].cumulativeY / m[0].dataSeries.plotUnit.dataPointYSums[z])))), "stackedColumn100" === m[s].dataSeries.type ? (v2 = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY, z = m[s].dataPoint.x.getTime ? m[s].dataPoint.x.getTime() : m[s].dataPoint.x, b = 100 * (v2 / m[s].dataSeries.plotUnit.dataPointYSums[z]), z = Math.abs(g - this.parent.convertValueToPixel(b)), z <= u && (u = z, y = s)) : "stackedArea100" === m[s].dataSeries.type && (v2 = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY, z = m[s].dataPoint.x.getTime ? m[s].dataPoint.x.getTime() : m[s].dataPoint.x, b = 100 * (v2 / m[s].dataSeries.plotUnit.dataPointYSums[z]), z = Math.abs(g - this.parent.convertValueToPixel(b)), z <= u && (u = z, y = s))) : "waterfall" === m[s].dataSeries.type ? (z = Math.abs(g - this.parent.convertValueToPixel(m[s].dataSeries.dataPointEOs[m[s].index].cumulativeSum)), z <= w && (u = w = z, y = s)) : (z = Math.abs(g - this.parent.convertValueToPixel(m[s].dataPoint.y)), z <= w && (w = z, y = s));
                p(u) || (w = Math.min(w, u));
              }
              u = m[y];
              s = 0;
              if ("rangeColumn" === u.dataSeries.type || "rangeArea" === u.dataSeries.type || "error" === u.dataSeries.type || "rangeSplineArea" === u.dataSeries.type || "candlestick" === u.dataSeries.type || "ohlc" === u.dataSeries.type || "boxAndWhisker" === u.dataSeries.type) {
                ...
                "stackedColumn" === u.dataSeries.type ? (b = u.dataSeries.dataPointEOs[u.index].cumulativeY, v2 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                  ...
                  value: b
                }) : p(this.options.label) ? da(p(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = b) : "stackedArea" === u.dataSeries.type ? (b = u.dataSeries.dataPointEOs[u.index].cumulativeY, v2 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b }) : p(this.options.label) ? da(p(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = b) : "stackedColumn100" === u.dataSeries.type ? (v2 = u.dataSeries.dataPointEOs[u.index].cumulativeY, z = u.dataPoint.x.getTime ? u.dataPoint.x.getTime() : u.dataPoint.x, b = 100 * (v2 / u.dataSeries.plotUnit.dataPointYSums[z]), v2 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b }) : p(this.options.label) ? da(p(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = b) : "stackedArea100" === u.dataSeries.type ? (v2 = u.dataSeries.dataPointEOs[u.index].cumulativeY, z = u.dataPoint.x.getTime ? u.dataPoint.x.getTime() : u.dataPoint.x, b = 100 * (v2 / u.dataSeries.plotUnit.dataPointYSums[z]), v2 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                  chart: this.chart,
                  axis: this.parent.options,
                  crosshair: this.options,
                  value: b
                }) : p(this.options.label) ? da(p(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = b) : "waterfall" === u.dataSeries.type ? (v2 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(u.dataSeries.dataPointEOs[u.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(u.dataSeries.dataPointEOs[u.index].cumulativeSum) << 0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: u.dataSeries.dataPointEOs[u.index].cumulativeSum }) : p(this.options.label) ? da(p(c) ? u.dataSeries.dataPointEOs[u.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = u.dataSeries.dataPointEOs[u.index].cumulativeSum) : (v2 = 1 === f.lineWidth % 2 ? (p(a) ? g : this.parent.convertValueToPixel(u.dataPoint.y) << 0) + 0.5 : p(a) ? g : this.parent.convertValueToPixel(u.dataPoint.y) << 0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: p(c) ? u.dataPoint.y : c }) : p(this.options.label) ? da(p(c) ? u.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = u.dataPoint.y);
              d2 = l2 = v2;
              b = this.chart.plotArea.x1;
              e = this.chart.plotArea.x2;
              this.bounds = { x1: b, y1: d2 - n / 2, x2: e, y2: l2 + n / 2 };
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position)
              ...
              ) && this.value <= Math.max(this.parent.viewportMinimum, this.parent.viewportMaximum) && 0 < n && (f.moveTo(b, d2), f.lineTo(e, l2), f.stroke(), this._hidden = false);
            ...
            if ("xySwapped" === this.chart.plotInfo.axisPlacement)
              if ("left" === this.parent._position || "right" === this.parent._position) {
                ...
                if (s) {
                  ...
                  k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ? this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: p(c) ? this.parent.convertPixelToValue(g) : c }) : p(this.options.label) ? da(p(c) ? this.parent.convertPixelToValue(g) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: p(c) ? this.parent.convertPixelToValue(g) : c }) : p(this.options.label) ? Ca(p(c) ? this.parent.convertPixelToValue(g) : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                  k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: p(c) ? this.parent.convertPixelToValue(a) : c }) : p(this.options.label) ? da(p(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.x = b - k.measureText().width / 2, k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width), k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1), "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2);
              }
            else if ("bottom" === this.parent._position || "top" === this.parent._position) {
              s = false;
              m = "";
              ...
              if (s) {
                ...
                k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ? this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: p(c) ? 0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "" : c }) : p(this.options.label) ? da(p(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({
                  chart: this.chart,
                  axis: this.parent.options,
                  crosshair: this.options,
                  value: p(c) ? this.parent.convertPixelToValue(a) : c
                }) : p(this.options.label) ? Ca(p(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
              k.x = b - k.measureText().width / 2;
              k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width);
              k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1);
              "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position && (k.y = this.parent.lineCoordinates.y1 - k.height + k.fontSize / 2 + 2);
            } else if ("left" === this.parent._position || "right" === this.parent._position)
              k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: p(c) ? this.parent.convertPixelToValue(g) : c }) : p(this.options.label) ? da(p(c) ? this.parent.convertPixelToValue(g) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.y = g + k.fontSize / 2 - k.measureText().height / 2 + 2, k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height + k.fontSize / 2), "left" === this.parent._position ? k.x = this.parent.lineCoordinates.x2 - k.measureText().width : "right" === this.parent._position && (k.x = this.parent.lineCoordinates.x2);
        ...
        V2.prototype.mouseMoveHandler = function(a, g) {
          this._lastUpdated && 4 > new Date().getTime() - this._lastUpdated || (this._lastUpdated = new Date().getTime(), this.chart.resetOverlayedCanvas(), this._updateToolTip(a, g), !this._updatedEventParameters || (isNaN(this._prevX) || isNaN(this._prevY)) || this.dispatchEvent("updated", this._updatedEventParameters, this));
        };
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
              ...
              if (0 <= this.currentSeriesIndex) {
                ...
                if (0 <= this.currentDataPointIndex)
                  ...
                  l2 = e.axisX.convertPixelToValue({ x: a }), k = e.getDataPointAtX(l2, c), p(k) || (k.dataSeries = e, this.currentDataPointIndex = k.index, b = k.dataPoint);
                else {
        ...
        V2.prototype.getToolTipInnerHTML = function(a) {
          ...
          if (this.isToolTipDefinedInData && (this.content && "function" === typeof this.content || this.contentFormatter))
            ...
            null === d2 && (d2 = "");
            d2 += this.chart.replaceKeywordsWithValue(h, b, c, e);
          }
          return d2;
        };
        ...
        W2.prototype.getNewObjectTrackingId = function() {
          return ++this.lastObjectId;
        };
        W2.prototype.mouseEventHandler = function(a) {
        ...
        W2.prototype.fireEvent = function(a, d2, c) {
          if (a && d2) {
        ...
        ja2.prototype.animate = function(a, d2, c, b, e) {
          ...
          e = e || N.easing.linear;
          c && this.animations.push({ startTime: new Date().getTime() + (a ? a : 0), duration: d2, animationCallback: c, onComplete: b });
          for (a = []; 0 < this.animations.length; )
            if (d2 = this.animations.shift(), c = new Date().getTime(), b = 0, d2.startTime <= c && (b = e(Math.min(
              c - d2.startTime,
              d2.duration
            ), 0, 1, d2.duration), b = Math.min(b, 1), isNaN(b) || !isFinite(b)) && (b = 1), 1 > b && a.push(d2), d2.animationCallback(b), 1 <= b && d2.onComplete)
              d2.onComplete();
          this.animations = a;
        ...
        } } }, Y = { drawMarker: function(a, d2, c, b, e, h, l2, p2) {
          if (c) {
            var t3 = 1;
...
export default require_canvasjs_min();
//# sourceMappingURL=@canvasjs_charts.js.map
