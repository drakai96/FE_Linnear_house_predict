...
CanvasJS.addColorSet("colors1", ["#BA68C8", "#9575CD", "#7986CB", "#64B5F6", "#4FC3F7", "#4DD0E1", "#4DB6AC", "#81C784", "#DCE775", "#FFD54F", "#FFB74D"]);
export default {
      ...
      options: {
        ...
        data: [{
          ...
          dataPoints: [
			...
			{label: "2009-10", y: 49.810},
			{label: "2010-11", y: 52.200},
			{label: "2011-12", y: 54.903},
			{label: "2012-13", y: 57.770},
